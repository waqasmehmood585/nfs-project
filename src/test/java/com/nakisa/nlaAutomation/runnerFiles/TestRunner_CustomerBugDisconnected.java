...
@CucumberOptions(
        ...
        tags = ("@CustomerBugDisconnected"),
        plugin = {"pretty", "json:Automation-Results/6_CustomerBug.json", "summary",
...
class TestRunner_CustomerBugDisconnected extends CustomAbstractTestNGCucumberTests {
