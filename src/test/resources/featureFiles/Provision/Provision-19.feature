Feature: Provision-19 Test Case
  NFS-11931 - Verify the impact of provisioning classification on schedules: Scenario-19

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify the impact of provisioning classification on schedules: Scenario-19
  #Jira_ID:NFS-11931
  #TC_Category:CustomerUAT
  #TC_Customers:Sephora
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @provision
  Scenario Outline: Provision-19 Test Case
    ...
    Then User click on the "Lease Component" with Name "Provision-19"
