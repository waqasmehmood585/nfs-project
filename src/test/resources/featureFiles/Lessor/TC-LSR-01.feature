Feature: TC-LSR-01 Test Case
  NFS-15662 - Lessor - Validate Accounting TC-LSR-01

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Lessor - Validate Accounting TC-LSR-01
  #Jira_ID:NFS-15662
  ...
  Scenario Outline: TC-LSR-01 Test Case
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "OperatingLease" Schedules from "2020-01-01" to "2021-12-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "OperatingLease" Schedules from "2020-01-01" to "2021-12-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Payment" Schedules from "2020-01-01" to "2021-12-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Payment" Schedules from "2020-01-01" to "2021-12-31"
