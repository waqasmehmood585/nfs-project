Feature: TC-LSR-09 Test Case
  NFS-15670 - Lessor - Validate Accounting TC-LSR-09

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Lessor - Validate Accounting TC-LSR-09
  #Jira_ID:NFS-15670
  ...
  Scenario Outline: TC-LSR-09 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-LSR-09"
