Feature: TC-LSR-06 Test Case
  NFS-15667 - Lessor - Validate Accounting TC-LSR-06

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Lessor - Validate Accounting TC-LSR-06
  #Jira_ID:NFS-15667
  ...
  Scenario Outline: TC-LSR-06 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      |       1000 | Lessor             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2023-01-01 | User Defined | 2023-06-30 | Schedule Period Dates | Yes         | Activation Group |
    ...
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Payment" Schedules from "2023-01-01" to "2023-06-30"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Payment" Schedules from "2023-01-01" to "2023-06-30"
    #--------------------Lease Component Event Level--------------------------
    Then User click on the "Lease Component" with Name "TC-LSR-06"
    ...
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types                | Posting Statuses | From Date Type | From Date  | To Date Type | To Date    | Posting Date Type     | Open Drafts | Entity Type      |
      |       1000 | Lessor             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2023-07-01 | User Defined | 2023-09-30 | Schedule Period Dates | Yes         | Activation Group |
    Then the "Batch" job should be completed with status "Done"
    #--------------------Search With ID--------------------------
    Then User Search "Activation Group" with ID
    #--------------------Operating Lease Schedule Validationn--------------------------
    And User clicks on "IAS" standard to validate "OperatingLease" schedule view at "Event1-LM" level
    And User clicks on "GAAP" standard to validate "OperatingLease" schedule view at "Event1-LM" level
    #--------------------Payment Schedule Validation--------------------------
    And User clicks on "IAS" standard to validate "Payment" schedule view at "Event1-LM" level
    And User clicks on "GAAP" standard to validate "Payment" schedule view at "Event1-LM" level
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "OperatingLease" Schedules from "2023-07-01" to "2023-09-30"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "OperatingLease" Schedules from "2023-07-01" to "2023-09-30"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Payment" Schedules from "2023-07-01" to "2023-09-30"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Payment" Schedules from "2023-07-01" to "2023-09-30"
    ...
    Then User enters the Terms and Conditions tab of Activation Group Event
    Then User index the Term and Condition number "1,3"
    And User sends the "Activation Group" for "ag-generate-schedules-btn" workflow transition
    And User sends the "Activation Group" for "ag-send-to-assessment-btn" workflow transition
    And User sends the "Activation Group" for "ag-approve-btn" workflow transition
    And User sends the "Activation Group" for "ag-confirm-classification-btn" workflow transition
    ...
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types                | Posting Statuses | From Date Type | From Date  | To Date Type | To Date    | Posting Date Type     | Open Drafts | Entity Type      |
      |       1000 | Lessor             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2023-10-01 | User Defined | 2024-12-31 | Schedule Period Dates | Yes         | Activation Group |
   Then the "Batch" job should be completed with status "Done"
    #--------------------Search With ID--------------------------
    Then User Search "Activation Group" with ID
    #--------------------Operating Lease Schedule Validationn--------------------------
    And User clicks on "IAS" standard to validate "OperatingLease" schedule view at "Event2-IN" level
    And User clicks on "GAAP" standard to validate "OperatingLease" schedule view at "Event2-IN" level
    #--------------------Payment Schedule Validation--------------------------
    And User clicks on "IAS" standard to validate "Payment" schedule view at "Event2-IN" level
    And User clicks on "GAAP" standard to validate "Payment" schedule view at "Event2-IN" level
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "OperatingLease" Schedules from "2023-10-01" to "2024-12-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "OperatingLease" Schedules from "2023-10-01" to "2024-12-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Payment" Schedules from "2023-10-01" to "2024-12-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Payment" Schedules from "2023-10-01" to "2024-12-31"
