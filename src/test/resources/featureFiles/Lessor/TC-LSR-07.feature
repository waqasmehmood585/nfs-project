Feature: TC-LSR-07 Test Case
  NFS-15668 - Lessor - Validate Accounting TC-LSR-07

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Lessor - Validate Accounting TC-LSR-07
  #Jira_ID:NFS-15668
  ...
  Scenario Outline: TC-LSR-07 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-LSR-07"
    ...
    Then User enters the Terms and Conditions tab of Activation Group Event
    Then User exercise the Term and Condition number "3,4"
    Then User index the Term and Condition number "3,4"
