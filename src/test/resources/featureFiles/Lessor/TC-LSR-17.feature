Feature: TC-LSR-17 Test Case
  NFS-15865 - Lessor - Validate Accounting TC-LSR-17

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Lessor - Validate Accounting TC-LSR-17
  #Jira_ID:NFS-15865
  ...
  Scenario Outline: TC-LSR-17 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-LSR-17"
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "OperatingLease" Schedules from "2020-10-01" to "2021-02-28"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "OperatingLease" Schedules from "2020-10-01" to "2021-02-28"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Payment" Schedules from "2020-10-01" to "2021-02-28"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Payment" Schedules from "2020-10-01" to "2021-02-28"
