Feature: TC-WM-06 Test Case
  NFS-12502: Validate TC-WM-06 for Walmart Pre Upgrade Scenario

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Customer Scenario TC-WM-06
  #Jira_ID:NFS-12502
  #TC_Category:CustomerUAT
  #TC_Customers:walmartPreUpgrade
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @walmartPreUpgrade
  Scenario Outline: TC-WM-06 Test Case
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-06-01" to "2021-06-30"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-06-01" to "2021-06-30"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-06-01" to "2021-06-30"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-06-01" to "2021-06-30"
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-07-01" to "2021-10-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-07-01" to "2021-10-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-07-01" to "2021-10-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-07-01" to "2021-10-31"
    #--------------------Lease Component Event Level--------------------------
    Then User click on the "Lease Component" with Name "TC-WM-06"
    Then User adds a New LC Event "Add Extension"
    ...
    And User makes the Rou End Date Change To "2023-05-31"
    Then User enters the Accounting tab of Activation Group
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-11-01" to "2023-05-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-11-01" to "2023-05-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-11-01" to "2023-05-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-11-01" to "2023-05-31"
