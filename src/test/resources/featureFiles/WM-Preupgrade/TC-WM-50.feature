Feature: TC-WM-50 Test Case
  NFS-12508: Validate TC-WM-50 for Walmart Pre Upgrade Scenario

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Customer Scenario TC-WM-50
  #Jira_ID:NFS-12508
  #TC_Category:CustomerUAT
  #TC_Customers:walmartPreUpgrade
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @walmartPreUpgrade
  Scenario Outline: TC-WM-50 Test Case
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-01-01" to "2021-02-28"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-01-01" to "2021-02-28"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-01-01" to "2021-02-28"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-01-01" to "2021-02-28"
    ...
    Then User click on the "Lease Component" with Name "TC-WM-50"
    ...
    #--------------------Activation Group Decrease in Term And Contract Rate change Event--------------------------
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-03-01" to "2022-11-30"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-03-01" to "2022-11-30"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-03-01" to "2022-11-30"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-03-01" to "2022-11-30"
    #--------------------Activation Group Indexation Event--------------------------
    ...
    #--------------------Lease Component Event Level--------------------------
    Then User click on the "Lease Component" with Name "TC-WM-50"
    Then User adds a New LC Event "Partial Termination"
    And User add new term and condition at "LC Event-2" level
    And User sends the "Lease Component Event" for "lc-send-to-approval-btn" workflow transition
    And User sends the "Lease Component Event" for "lc-approve-btn" workflow transition
    #--------------------Activation Group Terms & Conditions Reassessment And Contract Rate change Event--------------------------
...
#    Then User index the Term and Condition number "2"
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-12-01" to "2023-06-30"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-12-01" to "2023-06-30"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-12-01" to "2023-06-30"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-12-01" to "2023-06-30"
