Feature: TC-WM-38 Test Case
  NFS-1507: Validate TC-WM-38 for Walmart Pre Upgrade Scenario

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Customer Scenario TC-WM-38
  #Jira_ID:NFS-12507
  #TC_Category:CustomerUAT
  #TC_Customers:walmartPreUpgrade
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @walmartPreUpgrade
  Scenario Outline: TC-WM-38 Test Case
...
#    Then User index the Term and Condition number "1,2"
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-03-01" to "2021-10-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-03-01" to "2021-10-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-03-01" to "2021-10-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-03-01" to "2021-10-31"
...
#    Then User index the Term and Condition number "2"
    And User makes the Rou End Date Change To "2022-08-31"
    And User sends the "Activation Group" for "ag-generate-schedules-btn" workflow transition
    And User sends the "Activation Group" for "ag-send-to-assessment-btn" workflow transition
    And User sends the "Activation Group" for "ag-approve-btn" workflow transition
    And User sends the "Activation Group" for "ag-confirm-classification-btn" workflow transition
    ...
    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-11-01" to "2022-08-31"
#    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-11-01" to "2022-08-31"
#    #-------------------- Liability Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-11-01" to "2022-08-31"
#    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-11-01" to "2022-08-31"
