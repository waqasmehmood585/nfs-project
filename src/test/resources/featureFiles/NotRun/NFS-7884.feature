Feature: NFS-7884 Test Case
  NFS-7884: Golden: Audit Logs - Test Audit Log feature for FOS - Configurations

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "financial-org-structure" application url

  #TC_Title:Test Audit Log feature for FOS - Configurations
  #Jira_ID:NFS-7884
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4
#  @Regression @Xray @AuditLogs
  Scenario Outline: NFS-7884 Test Case
