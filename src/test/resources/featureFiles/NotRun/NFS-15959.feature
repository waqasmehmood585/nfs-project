Feature: NFS-15959 Test Case
  Verify Report for Disclosure Test Case TC-DR-06

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Report for Disclosure Test Case TC-DR-06
  #Jira_ID:NFS-15959
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @Regression @Xray @DR
  Scenario Outline: NFS-15959 Test Case
...
#      | <testCaseNumber> | Lessee             | List              | FINQ8S-300  | Fiscal Variant | PF             | All        | All           | 1000  | All              | All                | All         | All | All           |
...
#   #--------------------Disclosure Reports Profile & Job (IAS)--------------------------
#    Then User create Disclosure Report "Job" for "Disclosure Report-3"
...
#    Then User create Disclosure Report "Job" for "Disclosure Report-4"
...
#   #--------------------Disclosure Reports Profile & Job (GAAP)--------------------------
#    Then User create Disclosure Report "Job" for "Disclosure Report-5"
#    And User Download and Validate "GAAP" standard "Lease Liability" Report
#   #--------------------Disclosure Reports Profile & Job (GAAP)--------------------------
#    Then User create Disclosure Report "Job" for "Disclosure Report-6"
