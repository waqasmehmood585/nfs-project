Feature: TC-WA-03 Test Case
  NFS-12467 - Verify Schedules for Accounting Test Case WA-03

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case WA-03
  #Jira_ID:NFS-12467
  #TC_Category:CustomerUAT
  #TC_Customers:waters
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @waters
  Scenario Outline: TC-WA-03  Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-WA-03"
    ...
    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-05-01" to "2023-12-31"
#    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-05-01" to "2023-12-31"
#    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-05-01" to "2023-12-31"
#    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-05-01" to "2023-12-31"
    #--------------------Asset Transition Schedule Validation--------------------------
