Feature: TC-90 Test Case
  ...
  Scenario Outline: TC-90 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-90"
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-06-01" to "2023-12-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-06-01" to "2023-12-31"
    #-------------------- Liability Schedule Posting--------------------------
