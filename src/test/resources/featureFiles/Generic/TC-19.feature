...
#    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2017-01-01" to "2017-06-30"
    ...
    Then User click on the "Lease Component" with Name "TC-19"
