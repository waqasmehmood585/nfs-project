Feature: TC-35 Test Case
  ...
  Scenario Outline: TC-35 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      |       1000 | Lessee             | Post             | Erp System's Default | Accrual,Payment | Open             | User Defined   | 2022-01-01 | User Defined | 2023-03-31 | Schedule Period Dates | Yes         | Activation Group |
