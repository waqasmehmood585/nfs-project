Feature: TC-153 Test Case
  ...
  Scenario Outline: TC-153 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2016-08-01 | User Defined | 2017-05-31 | Schedule Period Dates | Yes         | Activation Group |
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2016-08-01" to "2017-05-31"
    Then User clicks on "GAAP" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2016-08-01" to "2017-05-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Validate" the "Payment" of "Liability" Schedules from "2016-08-01" to "2017-05-31"
    Then User clicks on "GAAP" Standard to "Validate" the "Payment" of "Liability" Schedules from "2016-08-01" to "2017-05-31"
    ...
    Then User click on the "Lease Component" with Name "TC-153"
    ...
    Then User exercise the Term and Condition number "1"
    And User makes the Rou End Date Change To "2018-03-31"
    ...
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types                | Posting Statuses | From Date Type | From Date  | To Date Type | To Date               | Posting Date Type | Open Drafts      | Entity Type |
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2017-06-01 | User Defined | 2017-10-31   | Schedule Period Dates | Yes               | Activation Group |
    Then the "Batch" job should be completed with status "Done"
      #--------------------Search With ID--------------------------
    Then User Search "Activation Group" with ID
    #--------------------Journal Document Validation--------------------------
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2017-06-01" to "2017-10-31"
    Then User clicks on "GAAP" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2017-06-01" to "2017-10-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Validate" the "Payment" of "Liability" Schedules from "2017-06-01" to "2017-10-31"
    Then User clicks on "GAAP" Standard to "Validate" the "Payment" of "Liability" Schedules from "2017-06-01" to "2017-10-31"
    #--------------------Asset Transition Schedule Validation--------------------------
...
#     --------------------Activation Group Terms & Conditions Reassessment Event--------------------------
    ...
    Then User changes the Contract Rate or IBR at "AG Event-3" level
    And User sends the "Activation Group" for "ag-generate-schedules-btn" workflow transition
    And User sends the "Activation Group" for "ag-send-to-assessment-btn" workflow transition
    And User sends the "Activation Group" for "ag-approve-btn" workflow transition
    And User sends the "Activation Group" for "ag-confirm-classification-btn" workflow transition
    ...
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types                | Posting Statuses | From Date Type | From Date  | To Date Type | To Date               | Posting Date Type | Open Drafts      | Entity Type |
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2017-11-01 | User Defined | 2018-01-31   | Schedule Period Dates | Yes               | Activation Group |
    Then the "Batch" job should be completed with status "Done"
      #--------------------Search With ID--------------------------
    Then User Search "Activation Group" with ID
    #--------------------Journal Document Validation--------------------------
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2017-11-01" to "2018-01-31"
    Then User clicks on "GAAP" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2017-11-01" to "2018-01-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Validate" the "Payment" of "Liability" Schedules from "2017-11-01" to "2018-01-31"
    Then User clicks on "GAAP" Standard to "Validate" the "Payment" of "Liability" Schedules from "2017-11-01" to "2018-01-31"
    #--------------------Asset Transition Schedule Validation--------------------------
