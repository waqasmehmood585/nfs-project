Feature: TC-135 Test Case
  ...
  Scenario Outline: TC-135 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2024-01-01 | User Defined | 2024-09-30 | Schedule Period Dates | Yes         | Activation Group |
    ...
    Then User click on the "Lease Component" with Name "TC-135"
    Then User adds a New LC Event "Extension Term"
    ...
    Then User makes the Rou End Date Change To "2025-12-31"
    Then User enters the Classification tab of Activation Group
    And User sends the "Activation Group" for "ag-generate-schedules-btn" workflow transition
