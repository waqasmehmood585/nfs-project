Feature: TC-106 Test Case
  ...
  Scenario Outline: TC-106 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2020-01-01 | User Defined | 2020-12-31 | Schedule Period Dates | Yes         | Activation Group |
    ...
    Then User click on the "Lease Component" with Name "TC-106"
