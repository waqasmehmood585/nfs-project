Feature: TC-97 Test Case
 ...
 #Jira_ID:NFS-14253
  ...
  Scenario Outline: TC-97 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-97"
    ...
    Then User makes the Rou End Date Change To "2023-06-30"
