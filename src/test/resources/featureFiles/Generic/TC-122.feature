Feature: TC-122 Test Case
  ...
  Scenario Outline: TC-122 Test Case
    ...
    Then User exercise the Term and Condition number "1,2,3,4,5"
    ...
    Then User enters the Terms and Conditions tab of Activation Group
    Then User index the Term and Condition number "4,5"
