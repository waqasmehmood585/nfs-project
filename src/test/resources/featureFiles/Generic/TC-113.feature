Feature: TC-113 Test Case
  ...
  Scenario Outline: TC-113 Test Case
    ...
    And User clicks on "GAAP" standard to validate "Liability" schedule view at "Event1-CA" level
     #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2024-01-01" to "2024-01-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2024-01-01" to "2024-01-31"
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2024-01-01" to "2024-01-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2024-01-01" to "2024-01-31"
    #--------------------Asset Transition Schedule Validation--------------------------
