Feature: TC-104 Test Case
 ...
 #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2020-01-01" to "2021-11-30"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2022-01-01" to "2021-11-30"
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2020-01-01" to "2021-11-30"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2020-01-01" to "2021-11-30"
