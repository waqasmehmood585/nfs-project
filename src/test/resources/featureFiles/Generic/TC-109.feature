Feature: TC-109 Test Case
  ...
  Scenario Outline: TC-109 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2022-01-01 | User Defined | 2022-11-30 | Schedule Period Dates | Yes         | Activation Group |
    ...
    Then User click on the "Lease Component" with Name "TC-109"
