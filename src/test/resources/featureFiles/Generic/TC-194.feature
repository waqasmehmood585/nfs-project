Feature: TC-194 Test Case
  ...
  Scenario Outline: TC-194 Test Case
    ...
    #--------------------Search With ID--------------------------
    Then User Search "Activation Group" with ID
    #--------------------Activation Group Indexation 2 Event--------------------------
    ...
    Then User click on the "Lease Component" with Name "TC-194"
