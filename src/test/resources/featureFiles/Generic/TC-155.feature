Feature: TC-155 Test Case
  ...
  Scenario Outline: TC-155 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-155"
    ...
    And User clicks on "GAAP" standard to validate "AssetTransition" schedule view at "Event1-LM" level
      #--------------------Lease Component Event Level--------------------------
    Then User click on the "Lease Component" with Name "TC-155"
    Then User adds a New LC Event "Purchase Option"
