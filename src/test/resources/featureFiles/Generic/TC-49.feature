Feature: TC-49 Test Case
  ...
  Scenario Outline: TC-49 Test Case
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2020-01-01" to "2020-08-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2020-01-01" to "2020-08-31"
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2020-01-01" to "2020-08-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2020-01-01" to "2020-08-31"
    #--------------------Lease Component Event Level--------------------------
    Then User click on the "Lease Component" with Name "TC-49"
    Then User adds a New LC Event "Termination Option Addition"
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2020-09-01" to "2020-09-30"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2020-09-01" to "2020-09-30"
    #--------------------Schedule Posting--------------------------
