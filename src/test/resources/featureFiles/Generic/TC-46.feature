Feature: TC-46 Test Case
  ...
  Scenario Outline: TC-46 Test Case
    ...
    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2020-01-01" to "2022-10-31"
#    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2020-01-01" to "2022-10-31"
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2020-01-01" to "2022-10-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2020-01-01" to "2022-10-31"
    ...
    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2022-11-01" to "2023-06-30"
#    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2022-11-01" to "2023-06-30"
#    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-11-01" to "2023-06-30"
#    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-11-01" to "2023-06-30"
