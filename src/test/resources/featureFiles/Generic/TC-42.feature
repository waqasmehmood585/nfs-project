Feature: TC-42 Test Case
  NFS-15183 - Verify Schedules for Accounting Test Case TC-42

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case TC-42
  #Jira_ID:NFS-15183
  #TC_Category:Engine/Core/Accounting
  #TC_Customers:walmartNUAT
  #TC_FixVersion:Nakisa 2024.R3
  @Engine/Core/Accounting @walmartNUAT
  Scenario Outline: TC-42 Test Case
