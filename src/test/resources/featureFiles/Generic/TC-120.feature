Feature: TC-120 Test Case
 ...
 #Jira_ID:NFS-6682
  ...
  Scenario Outline: TC-120 Test Case
    ...
    Then User selects the GAAP Indexation Treatment Type as "Standard"
    Then User enters the Terms and Conditions tab of Activation Group
    Then User index the Term and Condition number "1"
    Then User click on Term 1 to enter Indexation Information
    ...
    Then User click on the "Lease Component" with Name "TC-120"
    Then User adds a New LC Event "New Terms"
    ...
    And User clicks on "GAAP" standard to validate "AllColumns" schedule view at "AG-Close" level
     #--------------------Liability Schedule Validation After Close--------------------------
