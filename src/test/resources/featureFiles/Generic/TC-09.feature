Feature: TC-09 Test Case
  ...
  Scenario Outline: TC-09 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-09"
...
#      |       1000 | Activation Group Modification | LeaseModification-1         | null          | User Defined           | User Defined           | 2022-06-01   | 2022-06-01    | 2022-06-01        |         9.569 | Keep Current State | Apply on All T&Cs | Yes         | Activation Group | User Defined        | 2022-01-01     |
...
#    Then User Search "Activation Group" with ID
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-06-01" to "2022-09-30"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-06-01" to "2022-09-30"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-06-01" to "2022-09-30"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-06-01" to "2022-09-30"
    #--------------------Asset Transition Schedule Validation--------------------------
