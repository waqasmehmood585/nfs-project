Feature: NFS-7733 Test Case
  NFS-7733: GL Balance Report-Verify that user should be able to generate only Balance sheet report

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:GL Balance Report-Verify that user should be able to generate only Balance sheet report
  #Jira_ID:NFS-7733
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @GL
  Scenario Outline: NFS-7733 Test Case
