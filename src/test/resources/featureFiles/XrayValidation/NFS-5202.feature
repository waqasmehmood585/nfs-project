Feature: NFS-5202 Test Case
  NFS-5202 - Mass Indexation: Add Job Report Details Popup/Batch-Indexation Jobs (CPI Local) - Verify that if Indexation
  ...
  #TC_Title:Verify that if Indexation (CPI Local) task has failed items then user will see a Report button
  #Jira_ID:NFS-5202
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-5202 Test Case
    ...
    Then User tries to create Indexation Posting Job
      ...
      |        100 | Lessee             | User Defined           | 2023-06-01        | CPI Local               | null                     |                   -5.00 | null                        | null                   | Enforce Non-Lease         | Modification Date            | null                    | null                        | null                         | null                        | null                            | null                       | null                             | null                        | Modification Date | null         | null          | All                | null                 | All                 | null           | Yes         | Activation Group |
