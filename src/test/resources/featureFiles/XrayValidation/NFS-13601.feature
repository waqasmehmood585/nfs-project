Feature: NFS-13601 Test Case
  NFS-13601: Golden: Manage AG Closure: Dates and Balances - Verify new closing-AG Popup
  and Remaining Balances with multiple events

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Golden:Verify new closing-AG Popup and Remaining Balances with multiple events
  #Jira_ID:NFS-13601
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-13601 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-13601"
    ...
    Then User validated the Lease End Account Balances for "IAS"
    Then User validated the Lease End Account Balances for "GAAP"
