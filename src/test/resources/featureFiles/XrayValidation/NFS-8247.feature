Feature: NFS-8247 Test Case
  NFS-8247 - Verify that user is able to Delete and Enable/Disable Schedule Job
  ...
  Scenario Outline: NFS-8247 Test Case
    ...
    #--------------------Document Date and Posting Date Validation--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual" of "AllColumns" Schedules
    Then User verify the "Document date" is removed with "2023-01-01"
    Then User verify the "Posting date" is removed with "2023-01-01"
    Then User clicks on "IAS" Standard to "Post" the "Depreciation" of "AllColumns" Schedules
    Then User verify the "Document date" is removed with "2023-01-01"
    Then User verify the "Posting date" is removed with "2023-01-01"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "AllColumns" Schedules
    Then User verify the "Document date" is removed with "2023-01-01"
    Then User verify the "Posting date" is removed with "2023-01-01"
    Then User clicks on "GAAP" Standard to "Post" the "Depreciation" of "AllColumns" Schedules
    Then User verify the "Document date" is removed with "2023-01-01"
    Then User verify the "Posting date" is removed with "2023-01-01"
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules
    Then User verify the "Document date" is removed with "2023-01-01"
    Then User verify the "Posting date" is removed with "2023-01-01"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules
    Then User verify the "Document date" is removed with "2023-01-01"
    Then User verify the "Posting date" is removed with "2023-01-01"
    ...
    Then User Create Consolidated Transaction Report "Scheduled Job" for "Consolidated Transaction Report"
      ...
      | NFS-8247 | Profile               | IFRS                | 360 Convention | Posting Date    | 2023-01-01   | 2023-06-30 | All                  | null             | All                  | null         | null                           | null                    | null        | null        | null             | null               | Yes    | No    | No     | No      | No     | 1    | null | null      | null  |
