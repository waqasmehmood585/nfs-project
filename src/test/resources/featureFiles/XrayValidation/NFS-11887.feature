Feature: NFS-11887 Test Case
  NFS-11887: Verify that A.A by amount report is showing correct data when user apply Casualty event.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that A.A by amount report is showing correct data when user apply Casualty event
  #Jira_ID:NFS-11887
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @AAR
  Scenario Outline: NFS-11887 Test Case
