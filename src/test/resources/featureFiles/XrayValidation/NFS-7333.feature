Feature: NFS-7333 Test Case
  NFS-7333:Verify Schedules Fiscal Variant are generated correctly with Escalating Rent or Override First/Last Payment

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules Fiscal Variant are generated correctly with Escalating Rent or Override First/Last Payment
  #Jira_ID:NFS-7333
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-7333 Test Case
