Feature: NFS-11530 Test Case
  NFS-11530: Service Contract - Verify GL Balance Report Modifications.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Service Contract - Verify GL Balance Report Modifications.
  #Jira_ID:NFS-11530
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Regression @Xray @GL
  Scenario Outline: NFS-11530 Test Case
...
#    --------------------Master Agreement Level--------------------------
   ...
   #--------------------User Auxiliary Profile--------------------------
    ...
    Then User Create GL Balance Report "Job" for "GL Balance Report"
      ...
      | <testCaseNumber> | Document Date   | 360 Convention | 2023-01-01   | 2023-01-31 | null      | null                | null    | null            | Lessee             | IFRS                | External Posting | 10 - CAD      | List              | Lease Contract Service Contract | List                       | Service Contract     | All                              | null                   | All                | null   | All                      | null         | All                                | null                   | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    ...
    Then User Create GL Balance Report "Job" for "GL Balance Report"
      | Name             | Date Range Type | Calendar Type  | Period Start | Period End | From Year | From Posting Period | To Year | To Posting Year | Principal Position | Accounting Standard | Posting Category | Currency Type | Lease Type Filter | Lease Type                      | Classification Filter Type | Lease Classification | Internal Asset Class Filter Type | Internal Asset Classes | Vendor Filter Type | Vendor | Account Type Filter Type | Account Type | General Ledger Account Filter Type | General Ledger Account | Object Type      | Object List       | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | Document Date   | 360 Convention | 2023-01-01   | 2023-01-31 | null      | null                | null    | null            | Lessee             | GAAP                | External Posting | 10 - CAD      | List              | Lease Contract Service Contract | List                       | Service Contract     | All                              | null                   | All                | null   | All                      | null         | All                                | null                   | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
