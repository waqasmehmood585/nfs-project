Feature: NFS-13764 Test Case
  NFS-13764:Test Financial Income Statement Report for Low Value Contract

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Test Financial Income Statement Report for Low Value Contract
  #Jira_ID:NFS-13764
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Regression @Xray @ICStatement
  Scenario Outline: NFS-13764 Test Case
    ...
    Then User download and validate "Income Statement Report" for "IAS" Standard with "Low Value" Classification
    Then Open Hamburger menu & Click On "Reporting Module"-->""-->"Income Statement Report"
    Then User download and validate "Income Statement Report" for "GAAP" Standard with "Low Value" Classification
