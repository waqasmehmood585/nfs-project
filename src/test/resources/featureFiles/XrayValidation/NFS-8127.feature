Feature: NFS-8127 Test Case
  NFS-8127: Verify that user is able to Delete and Enable/Disable Schedule Job
  ...
  Scenario Outline: NFS-8127 Test Case
    ...
    Then User opens the "nakisa-financial-suite" application url
#    Then Open Hamburger menu & Click On "Reporting Module"-->"Periodic Posting Status Reports"-->"Periodic Profiles"
#    Then User create "Periodic Posting Status Report-1" profile for "Periodic Posting Status Reports"
    ...
    Then User create Periodic Posting Status Report "Scheduled Job" for "Periodic Posting Status Report"
      ...
      | NFS-8127 | All          | Regular Calendar | All                    | null            | All                    | null            | 2023-01-01 | 2023-12-31 | null      | null                | null    | null              | Lessee             | IFRS                | Finance        | Activation Group | ActivationGroup-1 | No     | Yes   | No     | No      | No     | 1    | 19   | null      | null  |
