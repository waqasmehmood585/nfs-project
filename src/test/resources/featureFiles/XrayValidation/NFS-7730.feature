Feature: NFS-7730 Test Case
  NFS-7730: Verify that user is able to cancel jobs under GL Balance Report Jobs

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that user is able to cancel jobs under GL Balance Report Jobs
  #Jira_ID:NFS-7730
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @GL
  Scenario Outline: NFS-7730 Test Case
    ...
    Then User Create GL Balance Report "Cancel Job" for "GL Balance Report"
      ...
      | <testCaseNumber> | Document Date   | 360 Convention | 2023-01-01   | 2023-03-31 | null      | null                | null    | null            | Lessee             | IFRS                | Internal Posting | 10 - CAD      | All               | null       | All                        | null                 | All                              | null                   | All                | null   | List                     | Balance Sheet | All                                | null                   | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
