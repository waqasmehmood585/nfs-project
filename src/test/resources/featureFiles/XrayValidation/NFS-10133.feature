Feature: NFS-10133 Test Case
  NFS-10133 - NLA: Test Indexation - Split - introduce rou anniversary date calculation: Verify ROU Anniversary scenario is
  applicable for leap year for all Indexation treatment type. Verify user should be able to apply the Non-Lease Indexation
  with User Defined Date

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify ROU Anniversary scenario is applicable for leap year for all Indexation treatment type.
  #Jira_ID:NFS-10133
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Indexation-Split
  Scenario Outline: NFS-10133 Test Case
