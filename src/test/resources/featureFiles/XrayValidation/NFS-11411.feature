Feature: NFS-11411 Test Case
  NFS-11411 - Conditional Indexation- Verify the Applicable Current Index Level is calculated according to the Maximum Percentage Change for CPI Global.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify the Applicable Current Index Level is calculated according to the Maximum Percentage Change for CPI Global.
  #Jira_ID:NFS-11411
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-11411 Test Case
