Feature: NFS-7450 Test Case
  NFS-7450: Verify that A.A by amount report is showing correct data when user apply TO event.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that A.A by amount report is showing correct data when user apply TO event.
  #Jira_ID:NFS-7450
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @XrayDisconnected @AAR
  Scenario Outline: NFS-7450 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-7450"
    ...
    Then User create Activity Analysis Report "Job" for "Activity Analysis Report"
      ...
      | <testCaseNumber> | By Amount   | Closed                  | 360 Convention | 2023-01-01 | 2023-06-30 | null      | null                | null    | null              | Lessee             | IFRS                | Finance        | Fixed Lease Contract | null    | null        | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    ...
    Then User create Activity Analysis Report "Job" for "Activity Analysis Report"
      | Name             | Report Type | Activation Group Status | Calendar Type  | From Date  | To Date    | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Accounting Standard | Classification | Lease Type                | Partner | Asset Class | Object List Type | Object List ID    | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | By Amount   | Closed                  | 360 Convention | 2023-01-01 | 2023-06-30 | null      | null                | null    | null              | Lessee             | GAAP                | Operating      | Fixed Lease Contract | null    | null        | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
