Feature: NFS-12197 Test Case
  NFS-12197: Validations for system classification and confirmed classification in cases of PO/Transfer of ownership/Specialized Asset at AG-Event.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Validations for system/confirmed classification in cases of PO/Transfer of ownership/Specialized Asset (Event)
  #Jira_ID:NFS-12197
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-12197 Test Case
    ...
    Then User validate the "Inception" Classifications Tab Values
      #--------------------Activation Group T&C Event Level--------------------------
    ...
    #--------------------Classification Page Validation--------------------------
    Then User validate the "AG Event-1" Classifications Tab Values
