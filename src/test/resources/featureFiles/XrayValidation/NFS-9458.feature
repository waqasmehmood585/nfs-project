Feature: NFS-9458 Test Case
  Verify Report for Disclosure Test Case TC-DR-08

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Report for Disclosure Test Case TC-DR-08
  #Jira_ID:NFS-9458
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @DR
  Scenario Outline: NFS-9458 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-DR-08"
   ...
   #--------------------Activation Group Terms & Conditions Reassessment Event--------------------------
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2022-03-01 | User Defined | 2022-12-31 | Schedule Period Dates | Yes         | Activation Group |
   ...
   #--------------------User Auxiliary Profile--------------------------
    ...
    Then User create Disclosure Report "Job" for "Disclosure Report"
      ...
      | <testCaseNumber> | 2022-03-01 | 2022-12-31 | null      | null                | null    | null              | Lessee             | Regular Calendar | IFRS                | Finance        | 95 - EUR | null                    | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | No                              | Yes                               | Yes                            | null   | null  | null   | null    | null   | null | null | null      | null  |
  ...
  #--------------------Disclosure Reports Profile & Job (GAAP)--------------------------
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date  | To Date    | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type    | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | 2022-03-01 | 2022-12-31 | null      | null                | null    | null              | Lessee             | Regular Calendar | GAAP                | Operating      | 95 - EUR | null                    | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | No                              | Yes                               | Yes                            | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
