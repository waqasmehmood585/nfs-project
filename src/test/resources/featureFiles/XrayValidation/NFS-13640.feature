Feature: NFS-13640 Test Case
  NFS-13640: Manage AG Closure: Dates and Balances – Verify AG Closure and
  Remaining balances with Short Term Contract

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify AG Closure and Remaining balances with Short Term Contract
  #Jira_ID:NFS-13640
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-13640 Test Case
    ...
    Then User validated the Lease End Account Balances for "IAS - Short term"
    Then User validated the Lease End Account Balances for "GAAP - Short term"
