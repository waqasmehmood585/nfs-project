Feature: NFS-13609 Test Case
  NFS-13609: Golden: Test NLA: Verify Unit Status Updated to "Returned" Upon AG Lease End and Closure

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Unit Status Updated to "Returned" Upon AG Lease End and Closure
  #Jira_ID:NFS-13609
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-13609 Test Case
    ...
    Then User validated the Unit status as "Returned" on AG level
