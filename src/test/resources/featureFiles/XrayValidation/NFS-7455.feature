Feature: NFS-7455 Test Case
  NFS-7455 - Verify that A.A Job is getting cancelled.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that A.A Job is getting cancelled.
  #Jira_ID:NFS-7455
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @AAR
  Scenario Outline: NFS-7455 Test Case
    ...
    Then User create Activity Analysis Report "Cancel Job" for "Activity Analysis Report"
      ...
      | <testCaseNumber> | By Amount   | Active                  | 360 Convention | 2023-01-01 | 2023-12-31 | null      | null                | null    | null              | Lessee             | IFRS                | Finance        | Lease contract (fix) | null    | null        | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
