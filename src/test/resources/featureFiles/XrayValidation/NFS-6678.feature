Feature: NFS-6678 Test Case
  NFS-6678 - Verify that users are able to post Payment, Accrual, Depreciation and Charges from Posting jobs in Batch management
  by selecting specific MA Display IDs in filtering

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify user is able to post Payment,Accrual,Depreciation,Charges from Posting jobs in Batch management (MA ID)
  #Jira_ID:NFS-6678
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-6678 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      |       1000 | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment,Charge | Open             | User Defined   | 2022-01-01 | User Defined | 2023-12-31 | Schedule Period Dates | Yes         | Master Agreement |
    ...
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types                       | Posting Statuses | From Date Type | From Date  | To Date Type | To Date    | Posting Date Type     | Open Drafts | Entity Type      |
      |       1000 | Lessee             | Reversal         | Erp System's Default | Accrual,Depreciation,Payment,Charge | Open             | User Defined   | 2022-01-01 | User Defined | 2023-12-31 | Schedule Period Dates | Yes         | Master Agreement |
    Then the "Batch" job should be completed with status "Done"
      #--------------------Search With ID--------------------------
    Then User Search "Activation Group" with ID
    #--------------------Charge Status--------------------------
