Feature: NFS-6906 Test Case
  NFS-6906: NLA: Terms - Verify that user should be able to copy the terms using the
  clone feature at LC Event level

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that user should be able to copy the terms using the clone feature at LC Event level
  #Jira_ID:NFS-6906
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-6906 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-6906"
