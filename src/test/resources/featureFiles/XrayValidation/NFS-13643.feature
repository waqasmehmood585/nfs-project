Feature: NFS-13643 Test Case
  NFS-13643: Manage AG Closure: Dates and Balances – Verify AG Closure and Remaining
  balances with Non Lease Service Contract

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify AG Closure and Remaining balances with Non Lease Service Contract
  #Jira_ID:NFS-13643
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-13643 Test Case
    ...
    Then User validated the Lease End Account Balances for "IAS - Service Contract"
    Then User validated the Lease End Account Balances for "GAAP - Service Contract"
