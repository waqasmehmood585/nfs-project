Feature: NFS-11426 Test Case
  NFS-11426 : Conditional Indexation- Verify conditional indexation is working as expected for split AGs.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify conditional indexation is working as expected for split AGs.
  #Jira_ID:NFS-11426
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-11426 Test Case
    ...
    #--------------------Search With ID--------------------------
    Then User click on the "Split Activation Group" with Name "NFS-11426"
     #--------------------Activation Group Level--------------------------
    Then User enters the Terms and Conditions tab of Activation Group
    Then User exercise the Term and Condition number "1,2"
    Then User enters the Accounting tab of Activation Group
