Feature: NFS-6675 Test Case
   NFS-6675 - Verify that users are able to post Payment, Accrual, Depreciation and Charges from Posting jobs in Batch management
   by selecting specific AG EVENT Display IDs in filtering

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify user is able to post Payment,Accrual,Depreciation,Charges from Posting jobs in Batch management (AG ID)
  #Jira_ID:NFS-6675
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-6675 Test Case
    ...
    And User Verify that Modification recognition fields are enabled for "2022-05-01"
