Feature: NFS-6898 Test Case
  NFS-6898: Golden: NLA: Post-Documents - Verify that Posted document on "Journals" on
  AG level, Charges and AG Event has "posting date", "Fiscal Year", "Fiscal Period"
  and "Company code" on the journal details

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that Posted document on "Journals" at AG level,Charges and AG Event has details
  #Jira_ID:NFS-6898
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-6898 Test Case
    ...
    #--------------------Charge Document Validation--------------------------
    Then User clicks on "IAS" standard to Post the Charge "1" with validation as "true"
    Then User clicks on "GAAP" standard to Post the Charge "1" with validation as "true"
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2023-01-01" to "2023-01-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2023-01-01" to "2023-01-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2023-01-01" to "2023-01-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2023-01-01" to "2023-01-31"
    #--------------------Lease Component Event Level--------------------------
    Then User click on the "Lease Component" with Name "NFS-6898"
    ...
    Then User click on the "Activation Group" with Name "NFS-6898"
