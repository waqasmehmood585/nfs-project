Feature: NFS-10144 Test Case
  NFS-10144 - Golden: NLA: Test Indexation - Split - Mass Indexation UI pop-up: Verify user should be able to split both
  Lease and Non-Lease Indexations

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify user should be able to split both Lease and Non-Lease Indexations
  #Jira_ID:NFS-10144
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Indexation-Split
  Scenario Outline: NFS-10144 Test Case
    ...
    Then User tries to create Indexation Posting Job
      ...
      | 1000       | Lessee             | User Defined           | 2023-04-01        | CPI Local               | null                     | 110                     | null                        | null                   | Standard                  | Modification Date            | null                    | CPI Local                   | null                         | 110                         | null                            | null                       | Modification Date                | null                        | Modification Date | null         | null          | All                | null                 | All                 | null           | Yes         | Activation Group |
