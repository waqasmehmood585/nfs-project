Feature: NFS-7806 Test Case
  NFS-7806: Verify that A.A job is not getting created when user skips any required field and the submit button is not enabled.
  ...
  #TC_Title:Verify that A.A job is not getting created when user skips any required field
  #Jira_ID:NFS-7806
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @AAR
  Scenario Outline: NFS-7806 Test Case
    ...
    Then User create Activity Analysis Report "Scheduled Job" for "Activity Analysis Report"
      ...
      | <testCaseNumber> | By Amount,By Count | Active                  | 360 Convention | null      | 2023-12-31 | null      | null                | null    | null              | Lessee             | IFRS                | Finance        | Fixed Lease Contract | null    | null        | Activation Group | ActivationGroup-1 | Yes    | No    | No     | No      | No     |    1 | null | null      | null  |
