Feature: NFS-14097 Test Case
  NFS-14097:Verify Financial Income statement Report with Multiple Events Applied

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Financial Income statement Report with Multiple Events Applied
  #Jira_ID:NFS-14097
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Regression @Xray @ICStatement
  Scenario Outline: NFS-14097 Test Case
