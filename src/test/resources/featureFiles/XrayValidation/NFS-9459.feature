Feature: NFS-9459 Test Case
  Verify Report for Disclosure Test Case TC-DR-05

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Report for Disclosure Test Case TC-DR-05
  #Jira_ID:NFS-9459
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @DR
  Scenario Outline: NFS-9459 Test Case
    ...
    Then User create Disclosure Report "Job" for "Disclosure Report"
      ...
      | <testCaseNumber> | 2022-01-01 | 2022-12-31 | null      | null                | null    | null              | Lessee             | Regular Calendar | IFRS                | Finance        | 10 - CAD | null                    | Contract         | Contract-1     | Yes                       | Yes              | Yes            | No                     | No                       | No                              | No                                | No                             | null   | null  | null   | null    | null   | null | null | null      | null  |
   ...
   #--------------------Disclosure Reports Profile & Job (IAS)--------------------------
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date  | To Date    | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type    | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | 2022-01-01 | 2022-06-30 | null      | null                | null    | null              | Lessee             | Regular Calendar | IFRS                | Finance        | 10 - CAD | null                    | Contract         | Contract-1     | No                        | No               | No             | Yes                    | Yes                      | No                              | Yes                               | Yes                            | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
    ...
    And User Download and Validate "IAS" standard "Weighted Avg Lease Term" Report
     #--------------------Disclosure Reports Profile & Job (GAAP)--------------------------
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date  | To Date    | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type    | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | 2022-01-01 | 2022-12-31 | null      | null                | null    | null              | Lessee             | Regular Calendar | GAAP                | Operating      | 10 - CAD | null                    | Contract         | Contract-1     | Yes                       | Yes              | Yes            | No                     | No                       | No                              | No                                | No                             | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
    ...
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date  | To Date    | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type    | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | 2022-01-01 | 2022-06-30 | null      | null                | null    | null              | Lessee             | Regular Calendar | GAAP                | Operating      | 10 - CAD | null                    | Contract         | Contract-1     | No                        | No               | No             | Yes                    | Yes                      | No                              | Yes                               | Yes                            | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
