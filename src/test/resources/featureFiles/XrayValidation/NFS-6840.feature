Feature: NFS-6840 Test Case
  NFS-6840: NLA: Approval and Rejection comments- Verify that user should be allowed to
  enter approval or rejection comments (Approver Comment at Event level Scenario)

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Approver Comment at Event level Scenario
  #Jira_ID:NFS-6840
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
Scenario Outline: NFS-6840 Test Case
   #--------------------Reading Test Case Excel--------------------------(approver comment at event level)
   ...
   Then User click on the "Lease Component" with Name "NFS-6840"
   ...
   Then User click on the "Activation Group" with Name "NFS-6840"
