Feature: NFS-7708 Test Case
  NFS-7708: Verify that add button should be disabled if mandatory field data is missing in GL Balance Profile

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "user-auxiliary" application url

  #TC_Title:Verify that add button should be disabled if mandatory field data is missing in GL Balance Profile
  #Jira_ID:NFS-7708
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-7708 Test Case
