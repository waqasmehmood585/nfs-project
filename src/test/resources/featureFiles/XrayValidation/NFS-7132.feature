Feature: NFS-7132 Test Case
  NFS-7132 -  Verify Fiscal Variant calander for CTR

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Fiscal Variant calander for CTR
  #Jira_ID:NFS-7132
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @CTR
  Scenario Outline: NFS-7132 Test Case
   ...
   #--------------------User Auxiliary Profile--------------------------
    ...
    Then User Create Consolidated Transaction Report "Job" for "Consolidated Transaction Report"
      ...
      | <testCaseNumber> | Object                | Nakisa Lease Accounting (NLA) | IFRS                | Fiscal Variant | Document Date   | 2023-01-01   | 2023-06-30 | All                  | null             | All                  | null         | null                           | null                    | Contract ID | Contract-1  | null             | null               | null   | null  | null   | null    | null   | null | null | null      | null  |
    ...
    Then User Create Consolidated Transaction Report "Job" for "Consolidated Transaction Report"
      | Name             | Filter Profile/Object | Application                   | Accounting Standard | Calendar Type  | Date Range Type | Period Start | Period End | Ledger Type filter 1 | Transaction Type | Ledger Type filter 2 | Ledger Types | External Posting Status Filter | External Posting Status | Object Type | Object List | Business Area ID | Functional Area ID | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | Object                | Nakisa Lease Accounting (NLA) | GAAP                | Fiscal Variant | Document Date   | 2023-01-01   | 2023-06-30 | All                  | null             | All                  | null         | null                           | null                    | Contract ID | Contract-1  | null             | null               | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
