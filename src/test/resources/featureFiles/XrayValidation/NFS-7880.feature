Feature: NFS-7880 Test Case
  NFS-7880: Verify that GL Balance Report should show correct values with Casualty Termination Event

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that GL Balance Report should show correct values with Casualty Termination Event
  #Jira_ID:NFS-7880
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @GL
  Scenario Outline: NFS-7880 Test Case
