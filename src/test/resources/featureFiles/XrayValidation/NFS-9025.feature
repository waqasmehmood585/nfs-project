Feature: NFS-9025 Test Case
  NFS-9025 : Revert AG - Scenario 3 - AG Activation with Event & No Charges

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Revert AG - Scenario 3 - AG Activation with Event & No Charges
  #Jira_ID:NFS-9025
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @GL
  Scenario Outline: NFS-9025 Test Case
    ...
    And User sends the "Activation Group" for "ag-activate-btn" workflow transition
    #--------------------Charge--------------------------
    Then User clicks on Charges to add charge at "AG Event-1" level
    ...
    Then User clicks on "IAS" schedule to validate "Internal" status of "AllColumns" is "Posted" from "2022-01-01" to "2022-03-31"
    Then User clicks on "GAAP" schedule to validate "Internal" status of "AllColumns" is "Posted" from "2022-01-01" to "2022-03-31"
    #--------------------Liability Schedule Status--------------------------
    Then User clicks on "IAS" schedule to validate "Internal" status of "Liability" is "Posted" from "2022-01-01" to "2022-03-31"
    Then User clicks on "GAAP" schedule to validate "Internal" status of "Liability" is "Posted" from "2022-01-01" to "2022-03-31"
    #--------------------Charge Status--------------------------
   ...
   #--------------------User Auxiliary Profile--------------------------
    ...
    Then User Create GL Balance Report "Job" for "GL Balance Report"
      ...
      | <testCaseNumber> | Posting Date    | 360 Convention | 2022-01-01   | 2022-12-31 | null      | null                | null    | null            | Lessee             | IFRS                | Internal Posting | 10 - CAD      | All               | null       | All                        | null                 | All                              | null                   | All                | null   | All                      | null         | All                                | null                   | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    ...
    Then User Create GL Balance Report "Job" for "GL Balance Report"
      | Name             | Date Range Type | Calendar Type  | Period Start | Period End | From Year | From Posting Period | To Year | To Posting Year | Principal Position | Accounting Standard | Posting Category | Currency Type | Lease Type Filter | Lease Type | Classification Filter Type | Lease Classification | Internal Asset Class Filter Type | Internal Asset Classes | Vendor Filter Type | Vendor | Account Type Filter Type | Account Type | General Ledger Account Filter Type | General Ledger Account | Object Type      | Object List       | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | Posting Date    | 360 Convention | 2022-01-01   | 2022-12-31 | null      | null                | null    | null            | Lessee             | GAAP                | Internal Posting | 10 - CAD      | All               | null       | All                        | null                 | All                              | null                   | All                | null   | All                      | null         | All                                | null                   | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
