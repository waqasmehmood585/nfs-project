Feature: NFS-9495 Test Case
  NFS-9495 - Verify that Terms & Conditions Reassessment event should be enabled.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that Terms & Conditions Reassessment event should be enabled.
  #Jira_ID:NFS-9495
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @XrayDisconnected @Core-Functionality
  Scenario Outline: NFS-9495 Test Case
