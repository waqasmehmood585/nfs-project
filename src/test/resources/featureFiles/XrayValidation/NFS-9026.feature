Feature: NFS-9026 Test Case
  NFS-9026 : Revert AG - Scenario 3 - AG Activation with Event & No Charges
  ...
  @Regression @Xray @GL
  Scenario Outline: NFS-9026 Test Case
    ...
    #--------------------Search With ID--------------------------
    Then User Search "Activation Group" with ID
    Then User clicks on "Revision" status "Activation Group" with name "Inception"
    #--------------------Revert the AG--------------------------
