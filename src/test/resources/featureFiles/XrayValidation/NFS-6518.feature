Feature: NFS-6518 Test Case
  NFS-6518: NLA: Termination Journal -Verify that Termination Journal matches with the Asset
  Part in All Columns schedules when user uses Purchase option, termination option or
  casualty in the Terms

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Termination Journal matches with Asset Part in All Columns when there's Purchase/termination option or casualty in the Terms
  #Jira_ID:NFS-6518
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @XrayDisconnected @Core-Functionality
  Scenario Outline: NFS-6518 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      |       1000 | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open,Failed      | User Defined   | 2023-01-01 | User Defined | 2024-12-31 | Schedule Period Dates | Yes         | Activation Group |
