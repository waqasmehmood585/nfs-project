Feature: NFS-8249 Test Case
  NFS-8249: Verify that user is able to edit and delete CTR & GL Schedule Job

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that user is able to edit and delete CTR & GL Schedule Job
  #Jira_ID:NFS-8249
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-8249 Test Case
    ...
    Then User Create Consolidated Transaction Report "Scheduled Job" for "Consolidated Transaction Report"
      ...
      | NFS-8249 | Profile               | IFRS                | 360 Convention | Posting Date    | 2023-01-01   | 2023-06-30 | All                  | null             | All                  | null         | null                           | null                    | null        | null        | null             | null               | Yes    | No    | No     | No      | No     | 1    | null | null      | null  |
    Then Users edit the created scheduled job for "Consolidated Transaction Report"
    ...
    Then User Create GL Balance Report "Scheduled Job" for "GL Balance Report"
      ...
      | <testCaseNumber> | Document Date   | 360 Convention | 2023-01-01   | 2023-03-31 | null      | null                | null    | null            | Lessee             | IFRS                | Internal Posting | 10 - CAD      | All               | null       | All                        | null                 | All                              | null                   | All                | null   | List                     | Balance Sheet | All                                | null                   | Activation Group | ActivationGroup-1 | Yes    | No    | No     | No      | No     | 1    | null | null      | null  |
    Then Users edit the created scheduled job for "GL Balance Report"
