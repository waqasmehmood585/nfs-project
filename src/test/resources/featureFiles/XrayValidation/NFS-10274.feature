Feature: NFS-10274 Test Case
  NFS-10274: Non-Lease Service CT - Verify user is able to apply UFCLP indexation on non-lease service contracts.
  should be able define inputs to refine the report generation
  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify user is able to apply UFCLP indexation on non-lease service contracts.
  ...
  Scenario Outline: NFS-10274 Test Case
