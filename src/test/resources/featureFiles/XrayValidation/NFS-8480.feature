Feature: NFS-8480 Test Case
  Verify Report for Disclosure Test Case TC-DR-04

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Report for Disclosure Test Case TC-DR-04
  #Jira_ID:NFS-8480
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @XrayDisconnected @DR
  Scenario Outline: NFS-8480 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-DR-04"
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2022-01-01 | User Defined | 2023-02-28 | Schedule Period Dates | Yes         | Activation Group |
    ...
    # --------------------Journal Document Validation--------------------------
    Then User clicks on "IAS" standard to validate "Termination" documents
    Then User clicks on "GAAP" standard to validate "Termination" documents
     #--------------------User Auxiliary Profile--------------------------
    Then User opens the "user-auxiliary" application url
    #--------------------Report Profile --------------------------
    ...
    Then Users create Profile for "Report"
      ...
      | <testCaseNumber> | Lessee             | List              | FINQ8S-300  | Fiscal Variant | PF             | All        | All           | FINQ8S-300 - CA - 1005 | All              | All         | All         | All | All           |
    ...
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date | To Date | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type  | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | null      | null    | 2022      | 5                   | 2023    | 5                 | Lessee             | Fiscal Variant | IFRS                | Finance        | 30 - USD | null                    | Contract         | Contract-1           | Yes                       | Yes              | Yes            | No                     | No                       | No                              | No                                | No                             | null   | null  | null   | null    | null   | null | null | null      | null  |
   ...
   #--------------------Disclosure Reports Job (IAS)--------------------------
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date | To Date | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type  | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | null      | null    | 2022      | 5                   | 2023    | 1                 | Lessee             | Fiscal Variant | IFRS                | Finance        | 30 - USD | null                    | Contract         | Contract-1           | No                        | No               | No             | Yes                    | No                       | No                              | No                                | No                             | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
    And User Download and Validate "IAS" standard "Lease Liability" Report
   #--------------------Disclosure Reports Job (IAS)--------------------------
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date | To Date | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type  | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | null      | null    | 2022      | 5                   | 2022    | 9                 | Lessee             | Fiscal Variant | IFRS                | Finance        | 30 - USD | null                    | Contract         | Contract-1           | No                        | No               | No             | No                     | Yes                      | No                              | Yes                               | Yes                            | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
    ...
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date | To Date | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type  | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | null      | null    | 2022      | 5                   | 2023    | 5                 | Lessee             | Fiscal Variant | GAAP                | Operating      | 30 - USD | null                    | Contract         | Contract-1           | Yes                       | Yes              | Yes            | No                     | No                       | No                              | No                                | No                             | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
   ...
   #--------------------Disclosure Reports Job (GAAP)--------------------------
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date | To Date | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type  | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | null      | null    | 2022      | 5                   | 2023    | 1                 | Lessee             | Fiscal Variant | GAAP                | Operating      | 30 - USD | null                    | Contract         | Contract-1           | No                        | No               | No             | Yes                    | No                       | No                              | No                                | No                             | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
    And User Download and Validate "GAAP" standard "Lease Liability" Report
   #--------------------Disclosure Reports Job (GAAP)--------------------------
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date | To Date | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Calendar Type  | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | null      | null    | 2022      | 5                   | 2022    | 9                 | Lessee             | Fiscal Variant | GAAP                | Operating      | 30 - USD | null                    | Contract         | Contract-1           | No                        | No               | No             | No                     | Yes                      | No                              | Yes                               | Yes                            | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
