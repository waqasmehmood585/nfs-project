Feature: NFS-11418 Test Case
  NFS-11418 - Salvage Value - Verify Salvage value field is added on LC, AG.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Salvage value field is added on LC, AG.
  #Jira_ID:NFS-11418
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-11418 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-11418"
    Then User adds a New LC Event "Add PO Term"
