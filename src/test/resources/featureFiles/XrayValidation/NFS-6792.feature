Feature: NFS-6792 Test Case
  NFS-6792: Verify that The escalation rent continues after the LC event and is not reset

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that The escalation rent continues after the LC event and is not reset
  #Jira_ID:NFS-6792
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-6792 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-6792"
    ...
    Then User click on the "Activation Group" with Name "NFS-6792"
