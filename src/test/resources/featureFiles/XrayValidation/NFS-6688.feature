Feature: NFS-6688 Test Case
  NFS-6688: NLA: Schedules - Verify that user is able to see the Vendor Split Posting in Schedules

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that user is able to see the Vendor Split Posting in Schedules
  #Jira_ID:NFS-6688
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @SAPPosting
  Scenario Outline: NFS-6688 Test Case
   ...
   Then Create SAP Posting Profile for System "FINQ8S-300" and Company "1000" and Accounting Standard "All"
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2023-01-01" to "2023-03-31"
    Then User clicks on "GAAP" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2023-01-01" to "2023-03-31"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Validate" the "Payment" of "Liability" Schedules from "2023-01-01" to "2023-03-31"
    Then User clicks on "GAAP" Standard to "Validate" the "Payment" of "Liability" Schedules from "2023-01-01" to "2023-03-31"
