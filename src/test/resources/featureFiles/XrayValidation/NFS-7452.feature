Feature: NFS-7452 Test Case
  NFS-7452: Verify that A.A by Count report is showing correct data when new term is added and indexation is applied

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that A.A by Count report is showing correct data when new term is added and indexation is applied
  #Jira_ID:NFS-7452
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @AAR
  Scenario Outline: NFS-7452 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-7452"
    ...
    Then User create Activity Analysis Report "Job" for "Activity Analysis Report"
      ...
      | <testCaseNumber> | By Amount   | Active                  | 360 Convention | 2022-01-01 | 2022-12-31 | null      | null                | null    | null              | Lessee             | IFRS                | Finance        | Fixed Lease Contract | null    | null        | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    ...
    Then User create Activity Analysis Report "Job" for "Activity Analysis Report"
      | Name             | Report Type | Activation Group Status | Calendar Type  | From Date  | To Date    | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Accounting Standard | Classification | Lease Type           | Partner | Asset Class | Object List Type | Object List ID    | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | By Amount   | Active                  | 360 Convention | 2022-01-01 | 2022-12-31 | null      | null                | null    | null              | Lessee             | GAAP                | Operating      | Fixed Lease Contract | null    | null        | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
