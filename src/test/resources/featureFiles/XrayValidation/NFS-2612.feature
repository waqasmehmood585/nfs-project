Feature: NFS-2612 Test Case
  NFS-2612: Schedules: Payment Columns - Verify that the Lease and Non-lease
  Payment Amount in Payment Columns is returned correctly when user Perform
  Rent Escalation - scenario 2

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that Lease/Non-lease Payment Amount is correct when user Perform Rent Escalation
  #Jira_ID:NFS-2612
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-2612 Test Case
