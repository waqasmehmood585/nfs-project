Feature: NFS-13860 Test Case
  NFS-13860: NLA: Test PO reference field - Verify Purchase order and Purchase organization
  fields are present in Mass Modification template

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Purchase order and Purchase organization fields are present in Mass Modification template
  #Jira_ID:NFS-13860
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-13860 Test Case
    ...
    Then User tries to create Modification Posting Job
      ...
      |        100 | Activation Group Modification| LeaseModification-1        | null           | User Defined            | User Defined          | 2024-06-01   | 2024-06-01    | 2024-06-01        | 5.00          | Keep Current State  | Apply on All T&Cs     | Yes         | Activation Group  | User Defined       | 2024-01-01      |
    ...
    Then User checks the File for Column Exist
      ...
      | Activation Group Accounting | Contract Rate,Use IBR,Purchase Organization Display ID,Purchase Order Display ID |
