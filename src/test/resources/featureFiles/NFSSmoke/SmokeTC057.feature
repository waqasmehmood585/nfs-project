Feature: SmokeTC057 Test Case
  NFS-14051 SmokeTC #57: Verify Cash Flow Report Columns are Correctly mapped for Inception and with Multiple events

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC057 - Verify Cash Flow Report Columns are Correctly mapped for Inception and with Multiple events
  #Jira_ID:NFS-14051
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Smoke @lessee @NFSSmoke-P6
  Scenario Outline: SmokeTC057 Test Case
    ...
    Then Open Hamburger menu & Click On "Reporting Module"-->"Financial Reports"-->"Cashflow Report"
    Then User download and validate "Cashflow Report" for "IAS" Standard with "Finance" Classification
    Then Open Hamburger menu & Click On "Reporting Module"-->""-->"Cashflow Report"
    Then User download and validate "Cashflow Report" for "GAAP" Standard with "Operating" Classification
