Feature: SmokeTC005 Test Case
  NFS-2086 SmokeTC # 05: Perform Sap External postings (Simple With GVI)

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC005 - Perform Sap External postings (Simple With GVI)
  #Jira_ID:NFS-2086
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P2
  Scenario Outline: SmokeTC005 Test Case
    #--------------------Reading Test Case Excel-------------------------- #Simple with GVI
 ...
 #--------------------Lease Component Event Level--------------------------
    Then User click on the "Lease Component" with Name "SmokeTC005"
