Feature: SmokeTC001 Test Case
  NFS-10817 SmokeTC # 01: Product TC 1 & 2

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC001 - Product TC 1 & 2
  #Jira_ID:NFS-10817
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P1
  Scenario Outline: SmokeTC001 Test Case
    ...
    Then User click on the "Lease Component" with Name "SmokeTC001"
    ...
    Then User exercise the Term and Condition number "2,3,4,5,6,7"
