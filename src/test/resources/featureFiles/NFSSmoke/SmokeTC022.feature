Feature: SmokeTC022 Test Case
  NFS-10886 SmokeTC # 22: Perform Mass Work Flow Job with Profile

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "user-auxiliary" application url

  #TC_Title:SmokeTC022 - Perform Mass Work Flow Job with Profile
  #Jira_ID:NFS-10886
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P5
  Scenario Outline: SmokeTC022 Test Case
    ...
    Then User tries to create Workflow Posting Job
      ...
      | 100        | true                   | Lessee             | Master Agreement | Active        | Callback         | No                | Master Agreement | null                           |
    Then the "Mass Workflow Batch" job should be completed with status "Transition Done"
      #--------------------Search With ID-----------------------------
    Then User Search "Master Agreement" with ID
    ...
    Then User tries to create Workflow Posting Job
      | Batch Size | Default Workbook Input | Principal Position | Target Entity    | Initial State | Action at Step 1 | Action at Step 2 | Allow Hitchhiking | Entity Type      | Document and Posting Date Type |
      | 100        | false                  | Lessee             | Master Agreement | Define        | Send to Approval | Approve          | No                | Master Agreement | null                           |
    ...
    Then User tries to create Workflow Posting Job
      | Batch Size | Default Workbook Input | Principal Position | Target Entity | Initial State | Action at Step 1 | Allow Hitchhiking | Entity Type | Document and Posting Date Type |
      | 100        | true                   | Lessee             | Contract      | Active        | Callback         | No                | Contract    | null                           |
    Then the "Mass Workflow Batch" job should be completed with status "Transition Done"
      #--------------------Search With ID-----------------------------
    Then User Search "Contract" with ID
    #--------------------Checking the Contract Status----------------------
    ...
    Then User tries to create Workflow Posting Job
      | Batch Size | Default Workbook Input | Principal Position | Target Entity | Initial State | Action at Step 1 | Action at Step 2 | Allow Hitchhiking | Entity Type | Document and Posting Date Type |
      | 100        | false                  | Lessee             | Contract      | Define        | Send to Approval | Approve          | No                | Contract    | null                           |
    Then the "Mass Workflow Batch" job should be completed with status "Pending User Input"
    Then User Upload the downloaded excel file of "Mass Workflow"
      #--------------------Search With ID-----------------------------
    Then User Search "Contract" with ID
    ...
    #--------------------Mass Workflow Transition Job for LC---------------------------------------
    Then Open Hamburger menu & Click On "Batch Management"-->""-->"Workflow Jobs"
    Then User tries to create Workflow Posting Job
      | Batch Size | Default Workbook Input | Principal Position | Target Entity   | Initial State | Action at Step 1 | Action at Step 2 | Allow Hitchhiking | Entity Type     | Document and Posting Date Type |
      | 100        | true                   | Lessee             | Lease Component | Define        | Send to Approval | Approve          | No                | Lease Component | null                           |
    Then the "Mass Workflow Batch" job should be completed with status "Transition Done"
      #--------------------Search With ID-----------------------------
    ...
    Then User tries to create Workflow Posting Job
      | Batch Size | Default Workbook Input | Principal Position | Target Entity   | Initial State | Action at Step 1 | Allow Hitchhiking | Entity Type     | Document and Posting Date Type |
      | 100        | true                   | Lessee             | Lease Component | Active        | Callback         | No                | Lease Component | null                           |
    Then the "Mass Workflow Batch" job should be completed with status "Transition Done"
      #--------------------Search With ID-----------------------------
    Then User Search "Lease Component" with ID
     #--------------------Checking the LC Status----------------------
    ...
    Then User verify that "Lease Component" status is "Active"
    #--------------------Move to AG--------------------------
    Then User click on the "Activation Group" with Name "SmokeTC022"
    ...
    Then User tries to create Workflow Posting Job
      ...
      | 100        | true                   | Lessee             | Activation Group | Define        | Generate Schedules | Send to Assessment | Approve          | Confirm Classification | No                | Activation Group | null                           |
    Then the "Mass Workflow Batch" job should be completed with status "Transition Done"
      #--------------------Search With ID-----------------------------
    Then User Search "Activation Group" with ID
    #--------------------Checking the AG Status----------------------
    Then User verify that "Activation Group" status is "Classified"
    #--------------------Mass Workflow Transition Job for AG---------------------------------------
    Then Open Hamburger menu & Click On "Batch Management"-->""-->"Workflow Jobs"
    Then User tries to create Workflow Posting Job
      | Batch Size | Default Workbook Input | Principal Position | Target Entity    | Initial State | Action at Step 1 | Allow Hitchhiking | Entity Type      | Document and Posting Date Type |
      | 100        | false                  | Lessee             | Activation Group | Classified    | Rework           | No                | Activation Group | null                           |
    Then the "Mass Workflow Batch" job should be completed with status "Transition Done"
    Then User Upload the downloaded excel file of "Mass Workflow"
    #--------------------Search With ID-----------------------------
    Then User Search "Activation Group" with ID
    ...
    Then Open Hamburger menu & Click On "Batch Management"-->""-->"Workflow Jobs"
    Then User tries to create Workflow Posting Job
      | Batch Size | Default Workbook Input | Principal Position | Target Entity    | Initial State | Action at Step 1   | Action at Step 2   | Action at Step 3 | Action at Step 4       | Action at Step 5 | Allow Hitchhiking | Entity Type      | Document and Posting Date Type |
      | 100        | false                  | Lessee             | Activation Group | Define        | Generate Schedules | Send to Assessment | Approve          | Confirm Classification | Activate         | No                | Activation Group | ROU Start/End Date             |
    Then the "Mass Workflow Batch" job should be completed with status "Done"
    Then User Upload the downloaded excel file of "Mass Workflow"
    #--------------------Search With ID-----------------------------
    Then User Search "Activation Group" with ID
    #--------------------Checking the AG Status----------------------
