Feature: SmokeTC020 Test Case
  NFS-13834 SmokeTC # 20:Test DQI AG Report for Contract Rate and CPI Local with all other Mandatory fields for report

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC020 -  DQI AG Report
  #Jira_ID:NFS-13834
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Smoke @lessee
  Scenario Outline: SmokeTC020 Test Case
    ...
    Then Open Hamburger menu & Click On "Reporting Module"-->"DQI Reports"-->"DQI AG Report"
    Then User download and validate "DQI AG Report"
