Feature: SmokeTC023 Test Case
  NFS-11084 SmokeTC # 23 Disclosure Reports for CAD - Verify user is able to generate disclosure reports for all the records without giving specific contract ID

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC023 - Disclosure Reports for CAD
  #Jira_ID:NFS-11084
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P1
  Scenario Outline: SmokeTC023 CAD Test Case
   ...
   #--------------------User Auxiliary Profile--------------------------
    ...
    Then User create Disclosure Report "Job" for "Disclosure Report"
      ...
      | <testCaseNumber> | 2023-01-01 | 2023-03-31 | Lessee             | Regular Calendar | IFRS                | Finance        | CAD      | Active                  | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | Yes                             | Yes                               | Yes                            | null   | null  | null   | null    | null   | null | null | null      | null  |
    ...
    Then User create Disclosure Report "Job" for "Disclosure Report"
      | Name             | From Date  | To Date    | Principal Position | Calendar Type    | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | 2023-01-01 | 2023-03-31 | Lessee             | Regular Calendar | GAAP                | Operating      | CAD | Active                  | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | Yes                             | Yes                               | Yes                            | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
