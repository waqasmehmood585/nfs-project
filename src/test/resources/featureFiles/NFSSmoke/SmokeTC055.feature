Feature: SmokeTC055 Test Case
  NFS-10883 SmokeTC # 55: UF-CLP Scenario

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC055 - UF-CLP Scenario
  #Jira_ID:NFS-10883
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P5
  Scenario Outline: SmokeTC055 Test Case
    ...
    Then User click on the "Lease Component" with Name "SmokeTC055"
