Feature: SmokeTC058 Test Case
  NFS-13759 SmokeTC058: Verify Income Statement Report with Impairment Loss and Gain Events

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC058 - Verify Income Statement Report with Impairment Loss and Gain Events
  #Jira_ID:NFS-13759
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2024.R1
  @Smoke @lessee @NFSSmoke-P2
  Scenario Outline: SmokeTC058 Test Case
