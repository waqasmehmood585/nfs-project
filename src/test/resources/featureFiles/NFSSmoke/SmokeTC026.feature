Feature: SmokeTC026 Test Case
  NFS-2097 SmokeTC # 26: Perform Sap External postings (UFCLP Scenario Without GVI)

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC026 - Perform Sap External postings (UFCLP Scenario Without GVI)
  #Jira_ID:NFS-2097
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P2
  Scenario Outline: SmokeTC026 Test Case
    #--------------------Reading Test Case Excel-------------------------- #UFCLP without GVI
