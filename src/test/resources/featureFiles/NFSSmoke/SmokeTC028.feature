Feature: SmokeTC028 Test Case
  NFS-2090 SmokeTC #28 : Mass Indexation - Create CPI Global Mass Indexation Profile & Job (Lease & Non-Lease)

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC028 - Create CPI Global Mass Indexation Profile & Job (Lease & Non-Lease)
  #Jira_ID:NFS-2090
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P3
  Scenario Outline: SmokeTC028 Test Case
    #--------------------Reading Test Case Excel-------------------------- CPI-Global (Lease & Non-Lease)
    ...
    Then User tries to create Indexation Posting Job
      ...
      | 100        | Lessee             | User Defined           | 2022-02-01        | CPI Global              | null                     | null                    | Modification Date           | null                   | Enforce Non-Lease         | Modification Date            | null                    | CPI Global                  | null                         | null                        | Modification Date               | null                       | Modification Date                | null                        | Modification Date | null         | null          | All                | null                 | All                 | null           | Yes         | Activation Group |
