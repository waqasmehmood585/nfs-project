Feature: SmokeTC017 Test Case
  NFS-10878 SmokeTC # 17: Perform Activity Analysis Report Job with Profile (IAS & GAAP)

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC017 - Perform Activity Analysis Report Job with Profile (IAS & GAAP)
  #Jira_ID:NFS-10878
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P2
  Scenario Outline: SmokeTC017 Test Case
    ...
    Then User create Activity Analysis Report "Job" for "Activity Analysis Report"
      ...
      | <testCaseNumber> | By Amount   | Closed                  | 360 Convention | 2023-01-01 | 2023-12-31 | null      | null                | null    | null              | Lessee             | IFRS                | Finance        | Fixed Lease Contract | null    | null        | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
