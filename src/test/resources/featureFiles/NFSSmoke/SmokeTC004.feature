Feature: SmokeTC004 Test Case
  NFS-10859 SmokeTC # 04: Perform multiple AG Events, then close AG using Termination Option

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC004 - Perform multiple AG Events, then close AG using Termination Option
  #Jira_ID:NFS-10859
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P5
  Scenario Outline: SmokeTC004 Test Case
    ...
    Then User click on the "Lease Component" with Name "SmokeTC004"
