Feature: SmokeTC025 Test Case
  NFS-10861 SmokeTC # 25: Perform multiple AG Events, then close AG using Casualty

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC025 - Perform multiple AG Events, then close AG using Casualty
  #Jira_ID:NFS-10861
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P1
  Scenario Outline: SmokeTC025 Test Case
    ...
    Then User click on the "Lease Component" with Name "SmokeTC025"
