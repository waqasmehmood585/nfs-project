Feature: SmokeTC048 Test Case
  NFS-11095 SmokeTC # 48: Verify Lessor Work Flow, Posting and Schedules

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC048 - Verify Lessor Work Flow, Posting and Schedules
  #Jira_ID:NFS-11095
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:N2025.R1
  @Smoke @lessor @NFSSmoke-P5
  Scenario Outline: SmokeTC048 Test Case
    ...
    Then User exercise the Term and Condition number "1,2,4,6"
...
#    And User enters the "Inception" Classification Values of Activation Group
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessor             | Post             | Erp System's Default | Accrual,Payment,Charge | Open             | User Defined   | 2022-01-01 | User Defined | 2022-06-30 | Schedule Period Dates | Yes         | Activation Group |
...
#    Then User clicks on "GAAP" standard to validate "Internal and External" status of "Journals" is "Posted"
    ...
    Then User clicks on "IAS" schedule to validate "Internal and External" status of "OperatingLease" is "Posted"
    Then User clicks on "GAAP" schedule to validate "Internal and External" status of "OperatingLease" is "Posted"
    #--------------------Liability Schedule Status--------------------------
    Then User clicks on "IAS" schedule to validate "Internal and External" status of "Payment" is "Posted"
    Then User clicks on "GAAP" schedule to validate "Internal and External" status of "Payment" is "Posted"
    #--------------------Batch Posting Profile & Job (Reversal)--------------------------
    Then Open Hamburger menu & Click On "Batch Management"-->"Operational Postings"-->"Operational Jobs"
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types          | Posting Statuses | From Date Type | From Date  | To Date Type | To Date    | Posting Date Type     | Open Drafts | Entity Type      |
      | 1000       | Lessor             | Reversal         | Erp System's Default | Accrual,Payment,Charge | Open             | User Defined   | 2022-01-01 | User Defined | 2022-06-30 | Schedule Period Dates | Yes         | Activation Group |
    Then the "Batch" job should be completed with status "Done"
    #--------------------SAP Posting Bot Profile & Job--------------------------
    Then User opens the "sap-posting-bot" application url
    Then Open Hamburger menu & Click On "SAP Posting Bot"-->"Posting Job"-->"SAP Posting Profiles"
   Then Create SAP Posting Profile for System "FINQ8S-300" and Company "1000" and Accounting Standard "All"
    ...
    #--------------------All Column Schedule Status--------------------------
    Then User clicks on "IAS" schedule to validate "Internal and External" status of "OperatingLease" is "Reversed"
    Then User clicks on "GAAP" schedule to validate "Internal and External" status of "OperatingLease" is "Reversed"
    #--------------------Liability Schedule Status--------------------------
    Then User clicks on "IAS" schedule to validate "Internal and External" status of "Payment" is "Reversed"
    Then User clicks on "GAAP" schedule to validate "Internal and External" status of "Payment" is "Reversed"
    #--------------------Batch Posting Profile & Job (Posting)--------------------------
    Then Open Hamburger menu & Click On "Batch Management"-->"Operational Postings"-->"Operational Jobs"
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types          | Posting Statuses | From Date Type | From Date  | To Date Type | To Date    | Posting Date Type     | Open Drafts | Entity Type      |
      | 1000       | Lessor             | Post             | Erp System's Default | Accrual,Payment,Charge | Open             | User Defined   | 2022-01-01 | User Defined | 2022-06-30 | Schedule Period Dates | Yes         | Activation Group |
