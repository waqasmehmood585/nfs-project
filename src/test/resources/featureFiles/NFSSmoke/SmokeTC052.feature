Feature: SmokeTC052 Test Case
  NFS-2077 SmokeTC # 52: Perform Sap External postings (UFCLP Scenario With GVI)

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:SmokeTC052 - Perform Sap External postings (UFCLP Scenario With GVI)
  #Jira_ID:NFS-2077
  #TC_Category:Smoke
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @Smoke @lessee @NFSSmoke-P3
  Scenario Outline: SmokeTC052 Test Case
    #--------------------Reading Test Case Excel-------------------------- #UFCLP with GVI
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment,Charge | Open             | User Defined   | 2022-01-01 | User Defined | 2022-12-31 | Schedule Period Dates | Yes         | Activation Group |
   ...
   Then Create SAP Posting Profile for System "FINQ8S-300" and Company "1000" and Accounting Standard "All"
    ...
    #Then User clicks on "GAAP" standard to validate "Internal and External" status of "Journals" is "Posted"  //No journal in case of Indexation
    #--------------------Charge Status--------------------------
    ...
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types                       | Posting Statuses | From Date Type | From Date  | To Date Type | To Date    | Posting Date Type     | Open Drafts | Entity Type      |
      | 1000       | Lessee             | Reversal         | Erp System's Default | Accrual,Depreciation,Payment,Charge | Open             | User Defined   | 2022-01-01 | User Defined | 2022-12-31 | Schedule Period Dates | Yes         | Activation Group |
    Then the "Batch" job should be completed with status "Done"
    #--------------------SAP Posting Bot Profile & Job--------------------------
    Then User opens the "sap-posting-bot" application url
    Then Open Hamburger menu & Click On "SAP Posting Bot"-->"Posting Job"-->"SAP Posting Profiles"
