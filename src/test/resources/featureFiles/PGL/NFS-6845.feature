Feature: NFS-6845 Test Case
  NFS-6845: PGL: WM Chile: Bad Validation in CTR Jobs

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Bad Validation in CTR Jobs
  #Jira_ID:NFS-6845
  #TC_Category:CustomerBug
  #TC_Customers:Walmart
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL @CTR
  Scenario Outline: NFS-6845 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2022-09-01 | User Defined | 2023-02-28 | Schedule Period Dates | Yes         | Activation Group |
    ...
    Then User Create Consolidated Transaction Report "Job" for "Consolidated Transaction Report"
      ...
      | <testCaseNumber> | Object                | Nakisa Lease Accounting (NLA) | IFRS                | 360 Convention | Document Date   | 2022-09-01   | 2023-02-01 | All                  | null             | All                  | null         | null                           | null                    | Contract ID | Contract-1  | null             | null               | null   | null  | null   | null    | null   | null | null | null      | null  |
    #--------------------Consolidated Transaction Reports Job GAAP--------------------------
    Then User Create Consolidated Transaction Report "Job" for "Consolidated Transaction Report"
      | Name             | Filter Profile/Object | Application                   | Accounting Standard | Calendar Type  | Date Range Type | Period Start | Period End | Ledger Type filter 1 | Transaction Type | Ledger Type filter 2 | Ledger Types | External Posting Status Filter | External Posting Status | Object Type | Object List | Business Area ID | Functional Area ID | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | Object                | Nakisa Lease Accounting (NLA) | GAAP                | 360 Convention | Document Date   | 2022-09-01   | 2023-02-01 | All                  | null             | All                  | null         | null                           | null                    | Contract ID | Contract-1  | null             | null               | null   | null  | null   | null    | null   | null | null | null      | null  |
