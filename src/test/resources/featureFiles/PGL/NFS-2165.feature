Feature: NFS-2165 Test Case
  NFS-2165: PGL: Finance lease with purchase option not getting picked up for indexation when
  running a mass indexation job.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Mass Indexation is not getting picked for Finance Lease
  #Jira_ID:NFS-2165
  #TC_Category:CustomerBug
  #TC_Customers:Walmart
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-2165 Test Case
    ...
    Then User tries to create Indexation Posting Job
      ...
      |       1000 | Lessee             | User Defined           | 2023-08-01         | CPI Global               |  null                    | null                     | Modification Date           | null                 | Company Default           |  Modification Date           | null                    |  null                         |  null                        | null                        | null                            | null                      |  null                            | null                        | Modification Date  | null         | null          | All                | null                 | All                 | null           |  Yes         | Activation Group |
