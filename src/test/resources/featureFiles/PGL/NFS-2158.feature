Feature: NFS-2158 Test Case
  ...
  #TC_Title:Incorrect posting and document dates at Indexation
  #Jira_ID:NFS-2158
  #TC_Category:CustomerBug
  #TC_Customers:Walmart
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-2158 Test Case
    ...
    And User sends the "Activation Group" for "ag-approve-btn" workflow transition
    And User sends the "Activation Group" for "ag-confirm-classification-btn" workflow transition
    Then User validate the Modification Recognition Popup dates at "AG Event-1" Level
    And User sends the "Activation Group" for "ag-activate-btn" workflow transition
