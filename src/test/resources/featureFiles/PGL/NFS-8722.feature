Feature: NFS-8722 Test Case
  NFS-8722: PGL: [Nakisa 2023.R4] The AG activation shows Schedule Generation Failed error (Regular Calendar scenario)

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:AG activation shows Schedule Generation Failure(Regular Calendar)
  #Jira_ID:NFS-8722
  #TC_Category:CustomerBug
  #TC_Customers:TEConnectivity
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-8722 Test Case
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2023-11-01 | User Defined | 2042-03-31 | Schedule Period Dates | Yes         | Activation Group |
