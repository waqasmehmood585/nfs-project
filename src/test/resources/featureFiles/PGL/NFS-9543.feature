Feature: NFS-9543 Test Case
  NFS-9543: PGL: Waters: Schedules generation is getting failed after adding
  free-rent/reduction on last period

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Schedules generation is failed after adding free-rent
  #Jira_ID:NFS-9543
  #TC_Category:CustomerBug
  #TC_Customers:Waters
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-9543 Test Case
