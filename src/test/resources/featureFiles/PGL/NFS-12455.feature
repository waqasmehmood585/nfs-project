Feature: NFS-12455 Test Case
  NFS-12455: PGL: Workflow: AG goes to Pending Termination state at Inception (PO Scenario)
  ...
  #TC_Title:AG goes to Pending Termination state at Inception (PO Scenario)
  #Jira_ID:NFS-12455
  #TC_Category:CustomerBug
  #TC_Customers:Walmart
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-12455 Test Case
