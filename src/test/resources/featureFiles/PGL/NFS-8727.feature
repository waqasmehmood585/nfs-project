Feature: NFS-8727 Test Case
  NFS-8727: PGL: Contract with Carry-over balances wrong inception entries for asset for TEC customer.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Contract with Carry-over balances contains wrong entries for asset
  #Jira_ID:NFS-8727
  #TC_Category:CustomerBug
  #TC_Customers:TEConnectivity
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-8727 Test Case
