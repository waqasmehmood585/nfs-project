Feature: NFS-2219 Test Case
  NFS-2219 :WM Chile: Schedules are incorrect after AG closure (Casualty Scenario)
  ...
  #TC_Title:Schedules are incorrect after AG closure (Casualty Scenario)
  #Jira_ID:NFS-2219
  #TC_Category:CustomerBug
  #TC_Customers:Walmart
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-2219 Test Case
