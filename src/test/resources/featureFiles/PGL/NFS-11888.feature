Feature: NFS-11888 Test Case
  NFS-11888: PGL: Te-connectivity: Block the user while adding the casualty if the casualty
  amount is lower than the unpaid interest expense

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Block the user while adding the casualty
  #Jira_ID:NFS-11888
  #TC_Category:CustomerBug
  #TC_Customers:TEConnectivity
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBugDisconnected @PGL
  Scenario Outline: NFS-11888 Test Case
    ...
    Then Users create Profile for "Batch"
      ...
      | <testCaseNumber> | Lessee             | List              | FINQ8S-300  |        001 | All           | All     | All              | All         | All         | All | All           | All             | All           |
    Then User opens the "nakisa-financial-suite" application url
    ...
    Then User tries to create Batch Posting Job
      ...
      |       1000 | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | User Defined   | 2024-01-01 | User Defined | 2024-04-30 | Schedule Period Dates | Yes         | Activation Group |
    ...
    #--------------------Payment Schedule Validation After Close--------------------------
    And User clicks on "IAS" standard to validate "Liability" schedule view at "AG-Close" level
    And User clicks on "GAAP" standard to validate "Liability" schedule view at "AG-Close" level
