Feature: NFS-2135 Test Case
  Pfizer: Internal Posting Failure due to an unexpected error

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Internal Posting Failure due to an unexpected error
  #Jira_ID:NFS-2135
  #TC_Category:CustomerBug
  #TC_Customers:Pfizer
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-2135 Test Case
    ...
    Then Users create Profile for "Batch"
      ...
      | <testCaseNumber> | Lessee             | List              | FINQ8S-300  | All        | All           | 1005    | All              | All         | All         | All | All           | All             | All           |
    Then User opens the "nakisa-financial-suite" application url
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment,Charge | Open             | User Defined   | 2023-01-01 | User Defined | 2023-12-31 | Schedule Period Dates | Yes         | Activation Group |
    ...
    #    Then Create SAP Posting Profile for System "FINQ8S-300" and Company "1005 - CA"
    ...
    Then User tries to create Batch Posting Job
      | Batch Size | Principal Position | Transaction Type | Reversal Reason      | Journal Types                       | Posting Statuses | From Date Type | From Date  | To Date Type | To Date    | Posting Date Type     | Open Drafts | Entity Type      |
      | 1000       | Lessee             | Reversal         | Erp System's Default | Accrual,Depreciation,Payment,Charge | Open             | User Defined   | 2023-01-01 | User Defined | 2023-12-31 | Schedule Period Dates | Yes         | Activation Group |
    Then the "Batch" job should be completed with status "Done"
    #    #--------------------SAP Posting Bot Profile & Job--------------------------
    #    Then User opens the "sap-posting-bot" application url
    #    Then Open Hamburger menu & Click On "SAP Posting Bot"-->"Posting Job"-->"SAP Posting Profiles"
