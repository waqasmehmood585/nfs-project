Feature: NFS-2139 Test Case
  NFS-2139 : PGL: RC2.4: Provisioning Posting requirements (Non-Lease Service Contract
  with Indexed case)
  ...
  #TC_Title:Provisioning Posting requirements with indexed case
  #Jira_ID:NFS-2139
  #TC_Category:CustomerBug
  #TC_Customers:Sephora
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-2139 Test Case
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Provision" of "Provision" Schedules from "2024-01-01" to "2024-04-30"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2024-01-01" to "2024-04-30"
    #-------------------- Liability Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "ProvisionPayment" of "ProvisionPayment" Schedules from "2024-01-01" to "2024-04-30"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2024-01-01" to "2024-04-30"
