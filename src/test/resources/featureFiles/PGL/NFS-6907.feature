Feature: NFS-6907 Test Case
  NFS-6907: PGL: Workflow: AG goes to Pending Termination state at Inception (TO Scenario)
  ...
  #TC_Title:AG goes to Pending Termination state at Inception (TO Scenario)
  #Jira_ID:NFS-6907
  #TC_Category:CustomerBug
  #TC_Customers:Walmart
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
    @CustomerBug @PGL
    Scenario Outline: NFS-6907 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-6907"
    ...
    And User sends the "Activation Group" for "ag-confirm-classification-btn" workflow transition
    And User sends the "Activation Group" for "ag-activate-btn" workflow transition
    #--------------------AG status Validation--------------------------
    Then User validate the "Activation Group" with status "Active"
