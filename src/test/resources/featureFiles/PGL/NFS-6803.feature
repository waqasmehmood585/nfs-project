Feature: NFS-6803 Test Case
  NFS-6803 - Revert not working on FairPrice PROD Instance

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Revert not working on FairPrice PROD Instance
  #Jira_ID:NFS-6803
  #TC_Category:CustomerBug
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-6803 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-6803"
