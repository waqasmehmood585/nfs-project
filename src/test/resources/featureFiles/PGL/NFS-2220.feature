Feature: NFS-2220 Test Case
  NFS-2220 :PGL: WM Chile: Schedules are incorrect after AG closure (Inception Scenario)
  ...
  #TC_Title:Schedules are incorrect after AG closure (Inception Scenario)
  #Jira_ID:NFS-2220
  #TC_Category:CustomerBug
  #TC_Customers:Walmart
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-2220 Test Case
