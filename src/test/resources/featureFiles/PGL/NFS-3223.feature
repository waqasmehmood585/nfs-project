Feature: NFS-3223 Test Case
  NFS-3223: PGL: NLA: Users can't post the last accrual and therefore can't "Lease End" the AG

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Users can't post the last accrual and therefore can't "Lease End" the AG
  #Jira_ID:NFS-3223
  #TC_Category:CustomerBug
  #TC_Customers:Walmart
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerBug @PGL
  Scenario Outline: NFS-3223 Test Case
    ...
    Then Users create Profile for "Batch"
      ...
      | <testCaseNumber> | Lessee             | List              | FINQ8S-300  | All        | All           | FINQ8S-300 - CA - 1000 | All              | All         | All         | All | All           | All             | All           |
    Then User opens the "nakisa-financial-suite" application url
    ...
    And User clicks on "GAAP" standard to validate "AllColumns" schedule view at "Event-1IN" level
