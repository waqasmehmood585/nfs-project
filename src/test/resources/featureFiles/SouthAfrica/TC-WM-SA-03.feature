Feature: TC-WM-SA-03 Test Case
  NFS-12482 - Verify Schedules for Accounting Test Case TC-WM-SA-03

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case TC-WM-SA-03
  #Jira_ID:NFS-12482
  #TC_Category:CustomerUAT
  #TC_Customers:walmartSouthAfrica
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @walmartSouthAfrica
  Scenario Outline: TC-WM-SA-03 Test Case
...
#    And User clicks on "GAAP" standard to validate "AssetTransition" schedule view at "Inception" level
    ...
    Then User click on the "Lease Component" with Name "TC-WM-SA-03"
    ...
    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2027-09-27" to "2027-10-24"
#    Then User clicks on "GAAP" Standard to "Validate" the "Accrual & Depreciation" of "AllColumns" Schedules from "2027-09-27" to "2027-10-24"
#    #-------------------- Liability Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Validate" the "Payment" of "Liability" Schedules from "2027-09-27" to "2027-10-24"
#    Then User clicks on "GAAP" Standard to "Validate" the "Payment" of "Liability" Schedules from "2027-09-27" to "2027-10-24"
    #--------------------Asset Transition Schedule Validation--------------------------
