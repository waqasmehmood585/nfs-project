Feature: TC-WM-SA-10 Test Case
  NFS-12487 - Verify Schedules for Accounting Test Case TC-WM-SA-10

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case TC-WM-SA-10
  #Jira_ID:NFS-12487
  #TC_Category:CustomerUAT
  #TC_Customers:walmartSouthAfrica
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @walmartSouthAfrica
  Scenario Outline: TC-WM-SA-10 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-WM-SA-10"
    Then User adds a New LC Event "Decrease Asset Term"
    ...
    Then User tries to create Batch Posting Job
      ...
      | 1000       | Lessee             | Post             | Erp System's Default | Payment       | Open             | User Defined   | 2022-08-01 | User Defined | 2027-09-30 | Schedule Period Dates | Yes         | Activation Group |
    Then the "Batch" job should be completed with status "Done"
    #--------------------Search With ID--------------------------
    Then User Search "Activation Group" with ID
    #--------------------Activation Group Decrease Asset Event--------------------------
