Feature: TC-PF-05 Test Case
  NFS-8466 - Verify Schedules for Accounting Test Case PF-05

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case PF-05
  #Jira_ID:NFS-8466
  #TC_Category:CustomerUAT
  #TC_Customers:pfizer
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @pfizer @Accounting @lesseeAccounting
  Scenario Outline: TC-PF-05 Test Case
    ...
    #--------------------Lease Component Event Level 1--------------------------
    Then User click on the "Lease Component" with Name "TC-PF-05"
