Feature: TC-PF-13 Test Case
  NFS-12460 - Verify Schedules for Accounting Test Case PF-13

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case PF-13
  #Jira_ID:NFS-12460
  #TC_Category:CustomerUAT
  #TC_Customers:pfizer
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @pfizer
  Scenario Outline: TC-PF-13 Test Case
    ...
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-01-01" to "2023-12-31"
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-01-01" to "2023-12-31"
    #--------------------Schedule Posting--------------------------
    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-01-01" to "2023-12-31"
    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-01-01" to "2023-12-31"
    ...
    Then User click on the "Lease Component" with Name "TC-PF-13"
    ...
    And User makes the Rou End Date Change To "2025-07-27"
    And User sends the "Activation Group" for "ag-generate-schedules-btn" workflow transition
    And User sends the "Activation Group" for "ag-send-to-assessment-btn" workflow transition
    And User sends the "Activation Group" for "ag-approve-btn" workflow transition
    And User sends the "Activation Group" for "ag-confirm-classification-btn" workflow transition
    ...
    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2024-01-01" to "2025-07-27"
#    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2024-01-01" to "2025-07-27"
#    #--------------------Schedule Posting--------------------------
#    Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2024-01-01" to "2025-07-27"
#    Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2024-01-01" to "2025-07-27"
    #--------------------Asset Transition Schedule Validation--------------------------
