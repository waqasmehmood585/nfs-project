Feature: NFS-14043 Test Case
  NFS-14043: NLA: Batch Schedular for internal postings- Verify that Schedular picks Multiple
  Postings of AG within same Month Correctly
  ...
  #TC_Title:Verify that Schedular picks Multiple Postings of AG within same Month Correctly
  #Jira_ID:NFS-14043
  #TC_Category:Regression
  #TC_Customers:None
   #TC_FixVersion:Nakisa 2024.R1
#  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-14043 Test Case
...
#    #--------------------Batch Posting Profile & Job--------------------------
    ...
    Then User opens the "nakisa-financial-suite" application url with "3rd" specific user
    ...
    Then User tries to create Batch Posting Schedule Job
      ...
      |<testCaseNumber>  | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | Activation Group ROU Start Date                      | 2024-01-01 | Job Execution Date      |Job Execution Date               |  Yes          | Activation Group |Hourly          |    1 | null | null      | null  | null        |
