Feature: NFS-8137 Test Case
  NFS-8137 - Verify that user is able to Delete and Enable/Disable Schedule Job
  ...
  #TC_Title:Verify that user is able to edit GL Balance schedule report job
  #Jira_ID:NFS-8137
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-8137 Test Case
