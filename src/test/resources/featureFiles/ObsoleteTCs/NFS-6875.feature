Feature: NFS-6875 Test Case
  NFS-6875 - Verify that Users should be allowed to select the effective date of indexation differently from the first payment date that this event affects

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Users should be allowed to select the effective date of indexation
  #Jira_ID:NFS-6875
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-6875 Test Case
    ...
    Then User click on the "Lease Component" with Name "NFS-6875"
