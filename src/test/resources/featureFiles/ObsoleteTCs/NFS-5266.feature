...
#    And User sends the "Activation Group" for "ag-activate-btn" workflow transition
    ...
    Then User Create Consolidated Transaction Report "Cancel Job" for "Consolidated Transaction Report"
      ...
      | <testCaseNumber> | Profile               | IFRS                | 360 Convention | Document Date   | 2023-01-01   | 2023-12-31 | All                  | null             | All                  | null         | null                           | null                    | null        | null        | null             | null               | null   | null  | null   | null    | null   | null | null | null      | null  |
