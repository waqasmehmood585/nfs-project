Feature: NFS-8122 Test Case
  NFS-8122 - Verify that user is able to create Schedule Job for Disclosure Report Hourly/Monthly/Weekly/Daily

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that user is able to create Schedule Job for Disclosure Report Hourly/Monthly/Weekly/Daily
  #Jira_ID:NFS-8122
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-8122 Test Case
    ...
    Then User create Disclosure Report "Scheduled Job" for "Disclosure Report"
      ...
      | NFS-8122 | 2023-01-01 | 2023-12-01 | Lessee             | null          | IFRS                | Finance        | 10 - CAD | Active                  | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | Yes                             | Yes                               | Yes                            | No     | Yes   | No     | No      | No     | 13   | 22   | null      | null  |
    Then User "Disable" Scheduled Job for "Disclosure Report-1"
    Then User deletes Scheduled Job for "Disclosure Report-1"
    Then User create Disclosure Report "Scheduled Job" for "Disclosure Report"
      | Name       | From Date  | To Date    | Principal Position | Calendar Type    | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | NFS-8122-2 | 2023-01-01 | 2023-12-01 | Lessee             | Regular Calendar | IFRS                | Finance        | 10 - CAD | Active                  | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | Yes                             | Yes                               | Yes                            | No     | No    | Yes    | No      | No     | 17   | null | Tuesday   | null  |
    Then User "Disable" Scheduled Job for "Disclosure Report-2"
    Then User deletes Scheduled Job for "Disclosure Report-2"
    Then User create Disclosure Report "Scheduled Job" for "Disclosure Report"
      | Name       | From Date  | To Date    | Principal Position | Calendar Type    | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | NFS-8122-3 | 2023-01-01 | 2023-12-01 | Lessee             | Regular Calendar | IFRS                | Finance        | 10 - CAD | Active                  | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | Yes                             | Yes                               | Yes                            | No     | No    | No     | Yes     | No     | 15   | 18   | null      | 11    |
    Then User "Disable" Scheduled Job for "Disclosure Report-3"
    Then User deletes Scheduled Job for "Disclosure Report-3"
    Then User create Disclosure Report "Scheduled Job" for "Disclosure Report"
      | Name       | From Date  | To Date    | Principal Position | Calendar Type    | Accounting Standard | Classification | Currency | Activation Group Status | Object List Type | Object List ID | Asset Roll Forward Report | Cash Flow Report | Expense Report | Lease Liability Report | Maturity Analysis Report | Non Lease Charge Expense Report | Weighted Avg Discount Rate Report | Weighted Avg Lease Term Report | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | NFS-8122-4 | 2023-01-01 | 2023-12-01 | Lessee             | Regular Calendar | IFRS                | Finance        | 10 - CAD | Active                  | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | Yes                             | Yes                               | Yes                            | No     | No    | No     | No      | Yes    | 13   | 22   | null      | May   |
