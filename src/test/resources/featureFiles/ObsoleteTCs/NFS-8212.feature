Feature: NFS-8212 Test Case
  NFS-8212- Verify that all the related columns are showing correct data in the respective field.

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that all the related columns are showing correct data in the respective field.
  #Jira_ID:NFS-8212
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @Regression @Xray @PPSR
  Scenario Outline: NFS-8212 Test Case
...
Then the "Batch" job should be completed with status "Done"
    ...
    Then User create Periodic Posting Status Report "Job" for "Periodic Posting Status Report"
      ...
      | <testCaseNumber> | All          | Regular Calendar | All                    | null            | All                    | null            | 2023-01-01 | 2023-12-31 | null      | null                | null    | null              | Lessee             | IFRS                | Finance,Short term,Low value,Service Contract | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    ...
    Then User create Periodic Posting Status Report "Job" for "Periodic Posting Status Report"
      | Name             | Posting Type | Calendar Type    | Internal Status Filter | Internal Status | External Status Filter | External Status | From Date  | To Date    | From Year | From Posting Period | To Year | To Posting Period | Principal Position | Accounting Standard | Classification                                          | Object List Type | Object List ID    | Hourly | Daily | Weekly | Monthly | Yearly | Hour | Date | Week Days | Month |
      | <testCaseNumber> | All          | Regular Calendar | All                    | null            | All                    | null            | 2023-01-01 | 2023-12-31 | null      | null                | null    | null              | Lessee             | GAAP                | Finance,Operating,Short term,Low value,Service Contract | Activation Group | ActivationGroup-1 | null   | null  | null   | null    | null   | null | null | null      | null  |
    Then the "Report" job should be completed with status "Done"
