Feature: NFS-8124 Test Case
  NFS-8124 - Verify that user is able to enable/disable and Delete Schedule Job

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify that user is able to enable/disable and Delete Schedule Job
  #Jira_ID:NFS-8124
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-8124 Test Case
    ...
    Then User create Disclosure Report "Scheduled Job" for "Disclosure Report"
      ...
      | NFS-8124 | 2023-01-01 | 2023-12-01 | Lessee             | Regular Calendar | IFRS                | Finance        | 10 - CAD | Active                  | Contract         | Contract-1     | Yes                       | Yes              | Yes            | Yes                    | Yes                      | Yes                             | Yes                               | Yes                            | Yes    | No    | No     | No      | No     | 1    | null | null      | null  |
