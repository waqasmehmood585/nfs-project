Feature: NFS-7298 Test Case
  NFS-7298 - Validate downloaded Periodic posting status report showing correct data

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Validate downloaded Periodic posting status report showing correct data
  #Jira_ID:NFS-7298
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @Regression @Xray @PPSR
  Scenario Outline: NFS-7298 Test Case
