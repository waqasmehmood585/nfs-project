Feature: NFS-12055 Test Case
  NFS-12055 Scenario: Mid Month Indexation amount frequency and payment frequency Monthly with escalating rent

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Mid Month Indexation amount frequency and payment frequency Monthly with escalating rent
  #Jira_ID:NFS-12055
  #TC_Category:Regression
  #TC_Customers:None
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-12055 Test Case
