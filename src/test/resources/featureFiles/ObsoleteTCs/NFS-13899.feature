Feature: NFS-13899 Test Case
  NFS-13899: NLA: Batch Schedular for internal postings- Verify that Schedule Jobs Run for From Date
  (Activation Groups ROU Start Date) with To Date (Job Execution Date and Period End Date)
  ...
  #TC_Title:NLA:Verify Schedule Jobs Run for From Date (Activation Groups ROU Start Date) with To Date (Job Execution Date and Period End Date)
  #Jira_ID:NFS-13899
  #TC_Category:Regression
  #TC_Customers:None
   #TC_FixVersion:Nakisa 2024.R1
#  @Regression @Xray @Core-Functionality
  Scenario Outline: NFS-13899 Test Case
    ...
    Then User tries to create Batch Posting Schedule Job
      ...
      | <testCaseNumber> | 1000       | Lessee             | Post             | Erp System's Default | Accrual,Depreciation,Payment | Open             | Activation Group ROU Start Date | 2024-01-01 | Period End Date | Job Execution Date           | Yes         | Activation Group | Hourly          | 1    | null | null      | null  | null        |
