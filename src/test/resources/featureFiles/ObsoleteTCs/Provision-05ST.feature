Feature: Provision-05ST Test Case
  NFS-2606 - Verify the impact of provisioning classification on schedules by performing the Accounting Scenario-5 - (SHORT TERM)

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify the impact of provisioning classification on schedules: Scenario-05 - (SHORT TERM)
  #Jira_ID:NFS-2606
  #TC_Category:CustomerUAT
  #TC_Customers:Sephora
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
#  @CustomerUAT @provision
  Scenario Outline: Provision-05ST Test Case
    ...
    Then User clicks on "GAAP" Standard to "Post" the "Accrual" of "AllColumns" Schedules from "2022-01-01" to "2022-12-31"
    #--------------------Schedule Posting--------------------------
