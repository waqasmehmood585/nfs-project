Feature: TC-UF-CLP-12 Test Case
   NFS-12498 - Verify Schedules for Accounting Test Case UF/CLP-12

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case UF/CLP-12
  #Jira_ID:NFS-12498
  #TC_Category:CustomerUAT
  #TC_Customers:UF/CLP
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @UF/CLP
  Scenario Outline: TC-UF-CLP-12 Test Case
    ...
    Then User clicks on "IAS" standard to validate "Impairment" documents
     #--------------------All Column Schedule Validation--------------------------
    And User clicks on "IAS" standard to validate "AllColumns" schedule view at "Event7-IM" level
    And User clicks on "GAAP" standard to validate "AllColumns" schedule view at "Event7-IM" level
    #--------------------Liability Schedule Validation--------------------------
    And User clicks on "IAS" standard to validate "Liability" schedule view at "Event7-IM" level
    And User clicks on "GAAP" standard to validate "Liability" schedule view at "Event7-IM" level
    #--------------------Schedule Posting--------------------------
    ...
    Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-12-01" to "2022-11-31"
    #-------------------- Liability Schedule Posting--------------------------
