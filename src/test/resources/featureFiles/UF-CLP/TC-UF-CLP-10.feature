Feature: TC-UF-CLP-10 Test Case
  NFS-8521 - Verify Schedules for Accounting Test Case UF/CLP-10

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case UF/CLP-10
  #Jira_ID:NFS-8521
  #TC_Category:CustomerUAT
  #TC_Customers:UF/CLP
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @UF/CLP
  Scenario Outline: TC-UF-CLP-10 Test Case
    ...
    Then User click on the "Lease Component" with Name "TC-UF-CLP-10"
    ...
    Then User clicks on "GAAP" standard to validate "LeaseModification" documents
     #--------------------All Column Schedule Validation--------------------------
    And User clicks on "IAS" standard to validate "AllColumns" schedule view at "Event9-LM" level
    And User clicks on "GAAP" standard to validate "AllColumns" schedule view at "Event9-LM" level
    #--------------------Liability Schedule Validation--------------------------
    And User clicks on "IAS" standard to validate "Liability" schedule view at "Event9-LM" level
    And User clicks on "GAAP" standard to validate "Liability" schedule view at "Event9-LM" level
    #--------------------Schedule Posting--------------------------
