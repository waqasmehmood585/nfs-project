Feature: TC-UF-CLP-16 Test Case
  NFS-12503: Verify Schedules for Accounting Test Case UF/CLP-16

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case UF/CLP-16
  #Jira_ID:NFS-12503
  #TC_Category:CustomerUAT
  #TC_Customers:UF/CLP
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @UF/CLP
  Scenario Outline: TC-UF-CLP-16 Test Case
...
#    Then User index the Term and Condition number "1"
    ...
    #--------------------Schedule Posting--------------------------
      Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-09-01" to "2022-02-28"
      Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2021-09-01" to "2022-02-28"
    #-------------------- Liability Schedule Posting--------------------------
      Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-09-01" to "2022-02-28"
      Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2021-09-01" to "2022-02-28"
    #--------------------Lease Component Event Level--------------------------
    Then User click on the "Lease Component" with Name "TC-UF-CLP-16"
    Then User adds a New LC Event "Extend the lease term"
    ...
    And User makes the Rou End Date Change To "2026-03-14"
    Then User enters the Accounting tab of Activation Group
    ...
    #--------------------Schedule Posting--------------------------
#      Then User clicks on "IAS" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-03-01" to "2026-03-31"
#      Then User clicks on "GAAP" Standard to "Post" the "Accrual & Depreciation" of "AllColumns" Schedules from "2022-03-01" to "2026-03-31"
#    #-------------------- Liability Schedule Posting--------------------------
#      Then User clicks on "IAS" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-03-01" to "2026-03-31"
#      Then User clicks on "GAAP" Standard to "Post" the "Payment" of "Liability" Schedules from "2022-03-01" to "2026-03-31"
