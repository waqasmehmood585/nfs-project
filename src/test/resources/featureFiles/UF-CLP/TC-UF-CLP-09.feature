Feature: TC-UF-CLP-09 Test Case
  NFS-12495 - Verify Schedules for Accounting Test Case UF/CLP-09

  Background: User needs to login into the application before performing the test case
    Given User logins into the NCP cockpit with correct credentials
    Then User opens the "nakisa-financial-suite" application url

  #TC_Title:Verify Schedules for Accounting Test Case UF/CLP-09
  #Jira_ID:NFS-12495
  #TC_Category:CustomerUAT
  #TC_Customers:UF/CLP
  #TC_FixVersion:Nakisa 2023.R4 & Earlier
  @CustomerUAT @UF/CLP @Accounting @lesseeAccounting
  Scenario Outline: TC-UF-CLP-09 Test Case
    ...
    And User sends the "Activation Group" for "ag-activate-btn" workflow transition
     #--------------------All Column Schedule Validation--------------------------
    And User clicks on "IAS" standard to validate "AllColumns" schedule view at "Event9-CA" level
    And User clicks on "GAAP" standard to validate "AllColumns" schedule view at "Event9-CA" level
    #--------------------Liability Schedule Validation--------------------------
    And User clicks on "IAS" standard to validate "Liability" schedule view at "Event9-CA" level
    And User clicks on "GAAP" standard to validate "Liability" schedule view at "Event9-CA" level
    #--------------------Schedule Posting--------------------------
