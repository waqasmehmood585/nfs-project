...
```
cd existing_repo
git remote add origin https://gitlab.com/nakisainc/qa/nfs-automation.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nakisainc/qa/nfs-automation/-/settings/integrations)
